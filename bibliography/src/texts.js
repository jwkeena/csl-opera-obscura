// FORMATTING
// RegEx to find capital letters separated by periods and a space: [A-Z]\. [A-Z]\.
...
const texts = [
    ...
    },
    {
        ...
        year: 1938,
        monthAndDay: "9 June",
        textProvided: "THE poetry of <i>Fox,</i> which is now to be considered, is more simple and unadorned than that of any other writer; nor need it excite the wonder of posterity if the regularity of nature and the sobriety of reason were not sufficient to save his compositions from disgust in an age when taste was formed on the incoherent excursions of <i>Eliot</i> and the petulant obscurity of <i>Pound</i>. But since the modes of error are agitated by continual change while truth remains always the same, his poetry now shines with undiminished lustre when the false wit of the Fantasticks is neglected by the polite, condemned by the judicious, and read by the learned with frigid indifference.<br><br>It does not appear that he formed his style, like <i>Wordsworth,</i> upon any philological system, or was guided to plainness of diction and justness of sentiment by any principles but those of his own genius. <i>Natvilcius</i> tells us that as Fox appears in his poetry, so he was in his conversation, and that in correcting the verses of his friends he invariably amputated exuberances and moderated enthusiasm: yet such was the sweetness of his address and the ease of his manners that we hear of no resentment inflamed and no friendship broken by this <i>Draconian</i> severity.<br><br>That he who sacrificed to the Muses with such parsimony sometimes solicited their kindness in vain, only panegyrical criticism will deny. If his poetry never disgusts us by the vacuity of affectation or the tremour of disproportionate splendour, it sometimes chills us with imbecility and avoids excellences as well as faults. Yet he has left no poem which does not please as a whole. He always performs more than he promises. The reader who at first expected only amusement finds himself insensibly transported, and wonders at last by what stealth a composition which seems to owe so little to art has afforded him so much pleasure and so much instruction.<br><br>The most considerable of his performances is the <i>King Coel,</i> a work which some have reproached as deficient in the unity of action. It must be allowed that the events related in the last book are not otherwise connected with the principal action of the poem than as they concern some of the same persons: but this is a fault which critical science discovers in vain while the common reader is content to be pleased. Others have enquired whether the poem be a just <i>epick,</i> an <i>epyllion,</i> or an <i>idyll;</i> but of disputes determinable by no appeal to reason or experience and originating only in the fury of nomenclature, who shall be the arbiter? The fable is probable, and there are no machines unless the soporifick faculty of the boy <i>Rufus</i> be so designated; and this so far conforms to the precepts of the ancients that it performs nothing which could have been performed without it. In this poem <i>Fox</i> writes about the middle sort of men and things, leading us through scenes neither splendid nor sordid, neither plunging us into the vulgarity of daily occupations nor summoning us into the airy regions of the marvellous, and engaging our interest in persons whose vices are not flagitious as their vertues are not beyond irritation. The old king is not very wise: but there is in his character much of the pathetick and every reader feels a kindness towards him. The love passages were concerned in his own day for their coldness and still excite the merriment of the <i>French</i> criticks; but he who reads to learn what may rationally be felt and innocently enjoyed will prefer them to the cant of profligacy and fashion, to the frenzies of <i>Calpronede,</i> the impurities of <i>Freud,</i> and the bathos of <i>Dell</i>. <i>Constantius</i> offers such love as a soldier and a man of sense may be expected to feel, and is rewarded with such affection as the nature of things commonly allows men to inspire.<br><br>In the <i>Sacred Satire,</i> as the theme is more awful, the manner is more severe. The sentiments are just and every reader wonders how he himself, on such a subject, has missed them. The lyrical piece prefixed to the Satire is one of the most pleasing effusion of poetical piety.<br><br>So little were the merits of <i>Fox</i> perceived by his own age that his elevation to the Chair of Poetry in the University of Oxford is said to have excited wonder. By this event <i>Natvilcius</i> tells us that no rival was mortified and no faction embittered, because all confessed that the supporters of Fox had neither overawed resistance by the splendour of their names nor undermined it by policy; that they had won by mere numbers a contest in which numbers are the only lawful means of victory; and that they had enrolled these numbers by no subtler strategem than that of disseminating widely what they believed sincerely. It is pleasing to learn that when the taste of the town was so corrupt, the justice and candour of the University remained thus unimpaired. Such are the obliquities of our vitiated nature that in some ages those very qualities which <i>Natvilcius</i> allows to the <i>Foxites</i> will be found more likely to irritate than to allay the displeasure of an adversary; nor is it recorded that <i>Goliath</i> found any consolation in reflecting that he who slew him was a shepherd and a boy.",
        type: "Prose",
    ...
    },
    {
        ...
        year: 1943,
        monthAndDay: null,
        textProvided: "NOTE.—Eight B.B.C. Talks are here printed, roughly (not exactly) as they were given on the air. Four fresh sections have been added to bring in points which I had not time to deal with in the actual Talks: they are marked with a letter after the numeral to distinguish them (IA. IVA. VIA, VIB.)<br><br>C.S.L.",
        type: "Prose",
        notes: null
    },
    {
    ...
    },
    {
        ...
        issueOrVolume: null,
        pageRange: "33, 131-132, 157, and 160",
        year: 1943,
        monthAndDay: null,
        textProvided: "[The title page of Book Two, 33, contains a quote attributed to “—PLATO<sup>1</sup>”]<br><br><sup>1</sup> Some think it wrongly attributed to him.<br><br>[From book Seven, chapter 10 (“Wisdom—Esoteric”), 131:<br><br>‘Try some of my brandy,’ said another voice. ‘All made by Savage’s dwarfs.’‘I don’t know how you can drink that stuff, Karl.<sup>1</sup> Plain, honest food from Claptrap is what you need.’<br>‘So you say, Herbert<sup>2</sup>,’ retorted a new speaker. ‘But some of us find it rather heavy. For me, a morsel of lamb from the Shepherd’s Country and a little mint sauce—that is really all you need to add to our Father’s table.’<br>‘We all know what you like, Benedict,’<sup>3</sup> said several.<br>‘I have finished,’ announced Karl, ‘and now for a night with the dwarfs. Anyone come with me?’<br>‘Not there,’ cried another. ‘I’m going South to-night to the magicians.’<br>‘You had much better not, Rudolph<sup>4</sup>,’ said someone. ‘A few quiet hours in Puritania with me would be much better for you—much better.’<br>‘Chuck it, Immanuel<sup>5</sup>,’ said another. ‘You might as well go to Mother Kirk straight away.’]<br><br><sup>1</sup> Marx<br><sup>2</sup> Spencer<br><sup>3</sup> Spinoza<br><sup>4</sup> Steiner<br><sup>5</sup> Kant<br><br>[From book Seven, chapter 10 (“Wisdom—Esoteric”), 132, continuing immediately from the previous excerpt:<br><br>‘Bernard<sup>1</sup> does,’ said the girl, who had contributed the claret.]<br><br><sup>1</sup> Bosanquet<br><br>[From Book Eight, chapter 9 (“Matter of Fact”), 157:<br><br>…Of course the Landlord was playing a dangerous game (nearly all his games are dangerous) and the Enemy managed to mix up and corrupt the new message—as usual—but not so much as he wished, or as people afterwards said: and before he had recovered himself, one at least<sup>1</sup> of the tenants had carried this new form of the desire right up to its natural conclusion and found what he had really been wanting. He wrote it all down in what he called a <i>Comedy</i>.’]<br><br><sup>1</sup> Dante<br><br>[From Book Eight, chapter 9 (“Matter of Fact”), 160:<br><br>…Why, bless my soul, I remember Homer in Pagus ridiculing some of the story pictures: but they had thousands of years to run still and thousands of souls were to get nourishment out of them. I remember Clopinel<sup>1</sup> in Medium Aevum, jeering at the pictures of the Lady before they had reached half his countrymen. But his jeer was no spell to evoke a new message, now was he helping any cause but the the Enemy’s.]<br><br><sup>1</sup> Jean de Meung",
        type: "Prose",
    ...
    },
    {
        ...
        issueOrVolume: null,
        pageRange: "dust jacket back flap",
        year: 1944,
        monthAndDay: null,
    ...
    },
    {
        ...
        year: 1945,
        monthAndDay: null,
        textProvided: "I have called this a fairy tale in the hope that no one who dislikes fantasy may be misled by the first two chapters into reading further, and then complain of his disappointment. If you ask why—intending to write about magicians, devils, pantomime animals, and planetary angels—I nevertheless begin with such humdrum scenes and persons, I reply that I am following the traditional fairy-tale. We do not always notice its method, because the cottages, castles, woodcutters, and petty kings with which a fairy-tale opens have become to us as remote as the witches and ogres to which it proceeds. But they were not remote at all to the men who made and first enjoyed the stories. They were, indeed, more realistic or commonplace than Bracton College is to me: for many German peasants had actually met cruel stepmothers, whereas I have never, in any university, come across a college like Bracton.<br><br>This is a “tall story” about devilry, though it has behind it a serious “point” which I have tried to make in my <i>Abolition of Man</i>. In the story the outer rim of that devilry had to be shown touching the life of some ordinary and respectable profession. I selected my own profession, not, of course, because I think fellows of colleges more likely to be thus corrupted than anyone else, but because my own profession is naturally that which I know best [1<sup>st</sup> US edition has “because my own is the only profession I know well enough to write about”]. A very small university is imagined because that has certain conveniences for fiction. Edgestow has no resemblance, save for its smallness, to Durham—a university with which the only connection I have ever had was entirely pleasant.<br><br>I believe that one of the central ideas of this tale came into my head from conversations I had with a scientific colleague, some time before I met a rather similar suggestion in the works of Mr. Olaf Stapledon. If I am mistaken in this, Mr. Stapledon is so rich in invention that he can well afford to lend; and I admire his invention (though not his philosophy) so much that I should feel no shame to borrow.<br><br>Those who would like to learn further about Numinor and the True West must (alas!) await the publication of much that still exists only in the MSS. of my friend, Professor J.R.R. Tolkien. <br><br>The period of this story is vaguely “after the war.” It concludes the trilogy of which <i>Out of the Silent Planet</i> was the first part, and <i>Perelandra</i> the second, but can be read on its own.<br><br>C.S. Lewis<br><i>Magdalen College, Oxford.</i><br>[1<sup>st</sup> UK edition ends here, but 1<sup>st</sup> US edition adds: <i>Christmas Eve, 1943</i>]",
        type: "Prose",
    ...
    },
    {
        ...
        textProvided: "When I was asked to write a Christmas sermon for Pagans I accepted the job light-heartedly enough: but now that I sit down to tackle it I discover a difficulty. Are there any Pagans in England for me to write to?<br><br>I know that people keep on telling us that this country is relapsing into Paganism. But they only mean it is ceasing to be Christian. And is that at all the same thing? Let us remember what a Pagan or Heathen (I use the words interchangeably) really was. <br><br>A “Heathen” meant a man who lived out on the heath, out in the wilds. A “Pagan” meant a man who lived in a <i>Pagus</i> or small village. Both words, in fact, meant a “rustic” or “yokel”. They date from the time when the larger towns of the Roman Empire were already Christianised, but the old Nature religions still lingered in the country. Pagans or Heathens were the backward people in the remote districts who had not yet been converted, who were still pre-Christian.<br><br>To say that modern people who have drifted away from Christianity are Pagans is to suggest that a post-Christian man is the same as a pre-Christian man. And that is like thinking that a woman who has lost her husband is the same sort of person as an unmarried girl: or that a street where the houses have been knocked down is the same as a field where no house has yet been built. The ruined street and the unbuilt field are alike in one respect: namely that neither will keep you dry if it rains. But they are different in every other respect. Rubble, dust, broken bottles, old bedsteads and stray cats are very different from [31] grass, thyme, clover, buttercups and a lark singing overhead.<br><br>Now the real Pagan differed from the post-Christian in the following ways. Firstly, he was religious. From the Christian point of view he was indeed too religious by half. He was full of reverence. To him the earth was holy, the woods and waters were alive. His agriculture was a ritual as well as a technique. And secondly, he believed in what we now call an “Objective” Right or Wrong. That is he thought the distinction between pious and impious acts was something which existed independently of human opinions: something like the multiplication table which Man had not invented but had found to be true and which (like the multiplication table) he had better take notice of. The gods would punish him if he did not.<br><br>To be sure, by Christian standards, his list of “Right” or “Wrong” acts was rather a muddled one. He thought (and the Christians agreed) that the gods would punish him for setting the dogs on a beggar who came to his door or for striking his father: but he also thought they would punish him for turning his face to the wrong point of the compass when he began ploughing. But though his code included some fantastic sins and duties, it got in most of the real ones. And this leads us to the third great difference between a Pagan and a post-Christian man. Believing in a real Right and Wrong means finding out that you are not very good. The Pagan code may have been on some points a low one: but it was too high for the Pagan to live up to. Hence a Pagan, though in many ways merrier than a modern, had a deep sadness. When he asked himself what was wrong with the world he did not immediately reply, “the social system,” or “our allies,” or “education.” It occurred to him that he himself might be one of the things that was wrong with the world. He knew he had sinned. And the terrible thing was that he thought the gods made no difference between voluntary and involuntary sins. You might get into their bad books by mere accident, and once in, it was very hard to get out of them. And the Pagan dealt with this situation in a rather silly way. His religion was a mass of ceremonies (sacrifices, purifications, etc.) which were supposed to take away guilt. But they never quite [32] succeeded. His conscience was not at ease. <br><br>Now the post-Christian view which is gradually coming into existence—it is complete already in some people and still incomplete in others—is quite different. According to it Nature is not a live thing to be reverenced: it is a kind of machine for us to exploit. There is no objective Right or Wrong: each race or class can invent its own code or “ideology” just as it pleases. And whatever may be amiss with the world, it is certainly not we, not the ordinary people; it is up to God (if, after all, He should happen to exist), or to Government, or to Education, to give us what we want. They are the shop, we are the customers: and “the customer is always right”.<br><br>Now if the post-Christian view is the correct one, then we have indeed waked from a nightmare. The old fear, the old reverence, the old restraints—how delightful to have waked up into freedom, to be responsible to no one, to be utterly and absolutely our own masters! We have, of course, lost some <i>fun</i>. A universe of colourless electrons (which is presently going to run down and annihilate all organic life everywhere and forever) is, perhaps, a little dreary compared with the earth-mother and the sky-father, the wood nymphs and the water nymphs, chaste Diana riding the night sky and homely Vesta flickering on the hearth. But one can’t have everything, and there are always the flicks and the radio: if the new view is correct, it has very solid advantages.<br><br>But is it? And if so, why are things not going better? What do you make of the present threat of world famine? We know now that it is not entirely due to the war. From country after country comes the same story of failing harvests: even the whales have less oil. Can it be that Nature (or something behind Nature) is not simply a machine that we can do what we like with?—that she is hitting back?<br><br>Waive that point. Suppose she is only a machine and that we are free to master her at our pleasure. Have you not begun to see that Man’s conquest of Nature is really Man’s conquest of Man? That every power wrested from Nature is used by some men over other men? Men are the victims, not the conquerors in the struggle: each new victory “over Nature” yields new means of propaganda to enslave them, new weapons to kill them, new power for the State and new weakness for the citizen, new contraceptives to keep men from being born at all.<br><br>As for the ideologies, the new invented Wrongs and Rights, does no one see the catch? If there is no <i>real</i> Wrong and Right, nothing good or bad in itself, none of these ideologies can be better or worse than another. For a better moral code can only mean one which comes nearer to some real or absolute code. One map of New York can be better than another only if there is a real New York for it to be truer <i>to</i>. If there is no objective standard, then our choice between one ideology and another becomes a matter of arbitrary taste. Our battle for democratic ideals [33] against Nazi ideals has been a waste of time, because the one is no better than the other. Nor can there ever be any real improvement or deterioration: if there is no real goal you can’t get either nearer to it or farther from it. In fact, there is no real reason for doing anything at all.<br><br>It looks to me, neighbours, as though we shall have to set about becoming true Pagans if only as a preliminary to becoming Christians. I don’t mean that we should begin leaving little bits of bread under the tree at the end of the garden as an offering to the Dryad. I don’t mean that we should dance to Dionysus across Hampstead Heath (though perhaps a little more solemn or ecstatic gaiety and a little less commercialised “amusements” might make our holidays better than they now are). I don’t even mean (though I very much wish) that we should recover that sympathy with nature, that religious attitude to the family and that appetite for beauty which the better Pagans had. Perhaps what I do mean is best put like this.<br><br>If the modern post-Christian view is wrong—and every day I find it harder to think it is right—then there are three kinds of people in the world. (1) Those who are sick and don’t know it (the post-Christian). (2) Those who are sick and know it (Pagans). (3) Those who have found the cure. And if you start in the first class you must go through the second to reach the third. For (in a sense) all that Christianity adds to Paganism is the cure. It confirms the old belief that in this universe we are up against Living Power: that there is a real Right and that we have failed to obey it: that existence is beautiful and terrifying. It adds a wonder of which Paganism had not distinctly heard—that the Mighty One has come down to help us, to remove our guilt, to reconcile us. <br><br>All over the world (even in Japan, even in Russia) men and women will meet on December 25th to do what is a very old-fashioned and, if you like, a very Pagan thing—to sing and feast because a God has been born. You are uncertain whether it is more than a myth. Well, if it is, then our last hope is gone. But is the opposite explanation not worth trying?<br><br>Who knows but that here, and here alone, lies your way back not only to Heaven, but to Earth too, and to the great human family whose oldest hopes are confirmed by this story that does not die?",
        type: "Prose",
    ...
    },
    {
        ...
        issueOrVolume: null,
        pageRange: "last page of front matter and 1-2, respectively",
        year: 1948,
        monthAndDay: null,
        textProvided: false,
        type: "Prose",
    ...
    },
    {
        ...
        year: 1963,
        monthAndDay: null,
        textProvided: "‘The critic means by <i>civilisation</i> things like big cities and offices. I mean things like justice, mercy, free speech, honour and courtesy. It is unfortunate that English uses the word in both senses.’ C.S.L.",
        type: "Prose",
        notes: null
    },
    {
    ...
    },
    {
        ...
        issueOrVolume: null,
        pageRange: "after the preface and before the introduction (holographs)",
        year: 1967,
        monthAndDay: null,
        textProvided: false,
        type: "Prose",
    ...
    },
    {
        ...
        year: 1971,
        monthAndDay: null,
        textProvided: "It was in autumn<br><br>[I have before me one of Lewis’s notebooks containing a fragment of a story about a boy who, in his garden, has been having an imaginary joust in the]<br><br>unchartered forests of Logres.<br><br>[...The joust ended, the boy is returning home:]<br><br>To remember suddenly that this was all a game was like hearing the voice of a friend: all the details of that “real” world that lay behind the game–the holidays just begun, the lighted, carpeted rooms, and, presently, the sound of teacups. . . . It was the strangest systole and diastole–no sooner was home regained, than that other world of desert hills and distant, ominous castles enisled in haunted woods, rose up, clothed in its turn with all the alluring colors of the long-lost. And so one swung backwards and forwards. Each world was best just as you left it for the other, as if to blow out these cloudy worlds and then to suck them in again were as functional as the rising and falling of the breast in sleep.",
        type: "Prose",
    ...
    },
    {
        ...
        printedIn: "Walter Hooper, “Past Watchful Dragons: The Fairy Tales of C.S. Lewis,” <i>Imagination and the Spirit,</i> ed. Charles A. Huttar (Grand Rapids: Eerdmans)",
        issueOrVolume: null,
        pageRange: "302 (holograph) and 303 (transcription)",
        year: 1971,
        monthAndDay: null,
        textProvided: false,
        type: "Prose",
    ...
    },
    {
        ...
        issueOrVolume: null,
        pageRange: "Appendix A (holograph)",
        year: 1981,
        monthAndDay: null,
        textProvided: false,
        type: "Prose",
    ...
    },
    {
        ...
        year: 1990,
        monthAndDay: null,
        textProvided: "[{30} It was through gramophone-record catalogues that C.S. Lewis first discovered Wagner, and his essay on]<br><br>the great Bayreuth Master <br><br>[written when he was barely thirteen, is by far the most remarkable production of his early years—a thousand times more impressive than his plays or his Animal-land fantasies. One sees what the middle-aged Lewis meant about the twelve-year-old being a prig and a snob. All the same, the expressions of that priggishness and snobbery are well turned, as when he says of Wagner that]<br><br>He has not been, nor ever will be, appreciated by the mass: there are some brains incapable of appreciation of the beautiful except when it is embodied in a sort of lyric prettiness.<br><br>[What impresses about the essay is the thoroughness with which Lewis, merely by listening to gramophone records and following the stories, had learnt to appreciate the great Wagnerian Ring cycle and Parsifal, {which Lewis called}]<br><br>his last and greatest work.<br><br>[He disdained Tannhäuser, in which Wagner was] <br><br>led away into the tinselled realms of tunefulness <br><br>[but considered Tristan unsurpassed as drama by anything the world had ever seen. {32}]<br><br>Once having grown to love Wagner’s peculiar richness of tone and the deep meaning of his music and the philosophy of his dramatic poems, all other composers seem but caricatures and ghosts. One of the most noticeable results of the advent of Wagner’s works in England is the rather paradoxical fact that he has made much more popular than they formerly were the lyrical operas to which he was so much opposed, <br><br>[the young essayist of Cherbourg had written.]",
        type: "Prose",
        notes: null
    },
    {
    ...
    },
    {
        ...
        year: 1992,
        monthAndDay: null,
        textProvided: "[18, identifying parts of a suit of armor illustrated by Lewis:]<br><br>Cote Armure --><br>BRACE --> <br>Sayn --><br>ON [=Old Norse]. <u>Djarfv</u> fortis > severus<br>Bayne --><br>Quissewes --><br>Knottes --><br>Greves --><br>Sabatounȝ --><br>Merely graphic?<br><br>[18, marginal notes, with line numbers in brackets:]<br><br>[563] <u>wandian</u>, shrink<br>[571] F. <u>Aduber</u>, ornare<br>[572] 186<br>[573] 155<br>[574] Provencal.<br>[576] fastened<br>[577] cf. ME [Middle English] <u>knag</u>, peg<br>[581] <u>Umbewæfan</u> (<u>wæfan</u>, clothe)<br>[582] Collective Pl.[ural]<br>[587] ON spenna, fasten<br><br>[18, Lewis’s footnotes:]<br><br>(1.) ON [Old Norse]. <u>Mennska</u>, humanitas > curialitas > favor > <u>m’ful</u>, honourable. (2.) The cptie.[?] forms in such contests naturally has little eptve.[?] sense. “Drew near” (3.) “Raised” made. (4.) To toy[?] > toyly experience > go through with. (5.) Intrans. “gets ready” (6.) Red silk of Toulouse > any red stuff. (7.) Here “drawn, spread”. Trahere [i.e., the Latin word for “to draw, stretch, drag”] happens to be the first meaning in Bs + Toll [Bosworth & Toller’s Anglo-Saxon Dictionary] for OE <u>tyhtan</u> but Edd. think its ME. usages in general are influenced by <u>dihtan</u>. (8) OF [Old French]. <u><Tarse/u>, Turkestan (9.) Tunic of Cappadocian leather. (10.) <u>þrawan</u> > <u>þrawen</u> tortus > well knit (110.) <u>Geyna</u>, prodesse [i.e. the Latin word for “to be useful” < prosum, prodesse, profui, profuturus]. (12) cf saynt (= ceint) 2431<br><br>[19, marginal notes, with line numbers in brackets:]<br><br>[590] OE <u>Hæpsian</u><br>[596] N<br>[599] <u>æghwær</u> | OE. <u>Notu</u><br>[600] striped<br>[601] 168<br>[602] horse-cloth | 171<br>[606] N<br>[608] leohtlic[?], candens<br>[610] strip<br>[611] preening (themselves)<br>[617] ad libitum<br><br>[19, Lewis’s footnotes:]<br><br>(1.) Participles agreeing w<sup>th</sup> <u>masse</u> (2.) Edd. derive the form from ON <u>Rykkja</u> but sense from the influence of OE. <u>Reccan</u> (stretch > relate > unravel > arrange, order, direct.) “Got up for this occasion” (3.) Accdng. to Edd. “It was all arrayed on a red background, was all studded with rich gold nails”-the second half of the line specifying the first. (4.) At intervals. (5.) True love knots. (6.) <u>Entailler</u> > to carve > to depict in needlework. (7.) “Many a lady had been at the job” (8.) A good passage for the meaning of <u>Brun</u> (9.) The attribution of the pentangle to Gawain who usually had other arms is possibility [sic] an innovation by this poet, for[?] conformity with the strongly ethical character of his work. L 623 points the same way.",
        type: "Prose",
        notes: null
    },
    {
    ...
    },
    {
        ...
        year: 1998,
        monthAndDay: null,
        textProvided: "Lewis had written “rivit”, then “revit”, and then “rivet”, then struck all three out, and wrote “FIX”",
        type: "Prose",
        notes: null
    },
    {
    ...
    },
    {
        ...
        year: 1998,
        monthAndDay: null,
        textProvided: "[in response to Sayers’s claim that Dante’s style is lucid:]<br><br>Great gods! Yes, I know it is in places—but lucid just like that! Whose style would you call obscure I’d like to know?",
        type: "Prose",
        notes: null
    },
    {
    ...
    },
    {
        ...
        pageRange: "95 note 24",
        year: 1998,
        monthAndDay: null,
        textProvided: "[Ms. 861.69; Bodleian Library. Beneath the poem is the following, apparently in Lewis’s handwriting:]<br><br>C.S. Lewis, Magdalen College, Oxford<br><br>[Further down are the words]<br><br>Feminine, livy, fright (?)<br><br>[still in Lewis’s hand; I suppose Lewis was using these as he struggled for rhymes.]",
        type: "Prose",
        notes: null
    },
    {
    ...
    },
    {
        ...
        year: 1999,
        monthAndDay: null,
        textProvided: "[The first attempt at the story, which Warnie calls “Text A”, concerns a character clearly based on Jack’s own experiences, asserting a claim to his “kingdom.” This “kingdom” is in an old attic room of his father’s house and its treasure consists of all the stories, plays, songs, and drawings that the young protagonist has accumulated since early childhood. The father in the story is introduced and when seated]<br><br>silent and unmoving as a Yogi<br><br>[the tension palpably increases and the character remarks that the silence of the little end room]<br><br>swelled like a bubble till I thought it must instantly burst into some undefined catastrophe.<br><br>[We learn that the son is fourteen and an only child. His mother had died]<br><br>in giving me birth<br><br>[The fictional father is in some unspecified]<br><br>business<br><br>[though to the son this merely means that the father leaves the house in the morning and returns in the evening. On his father’s return, the youth would have to be seated in the dining room next to the fire, having been]<br><br>forbidden<br><br>[to sit in his]<br><br>kingdom<br><br>[by his father due to his weak chest and persistent colds. The rest of the fragment attempts to articulate and assert his, rather melodramatic, sense of individuality. …{32} Text A also contains an account of adolescent angst that suggests an imaginative amalgamation of his schoolboy experiences at Campbell College. We learn that the young protagonist made no friends, was in his own words]<br><br>a thoroughgoing snob<br><br>[and having surmounted bullying and general unhappiness, wins at least toleration from his fellow pupils. The image of the]<br><br>big house<br><br>[and the “kingdom” therein as sanctuary and refuge from the]<br><br>clamour of the boys, the playground, the sordid books<br><br>[is subtly evoked. Following the road up the hill beyond his father’s house and leaving behind]<br><br>the fields and works of men<br><br>[Text A’s protagonist passes solitary hours upon the moor smoking cigarettes, reading, writing, and staring]<br><br>myself dizzy upon the blue hills or (lying in the heather) upon the tremendous cliffs and towers of summer cloud, eating out my heart with vague and indistinguishable desires.<br><br>[Inevitably, the consequence of being such a]<br><br>vain, introspective, prurient, and romantic<br><br>[boy was the derision of his peers and this is masterfully and painfully portrayed in Text A, where he describes himself as a]<br><br>dull, slouching, unattractive boy<br><br>[Envying his more popular peers, the]<br><br>enforced spectator<br><br>[attempts to ingratiate himself by joining in their conversation, perhaps with a joke]<br><br>long meditated<br><br>[in solitude, only to be jeered, red-faced, into embarrassed silence. He finds compensation for this treatment in dreams where he is the]<br><br>hero<br><br>[and people do not]<br><br>stare or titter<br><br>[when he speaks, and if they do he {33} at least has the courage and strength to hit back. This unfinished story ends with the boy returning home to his father, after a day on the moors, to face his fate. What this fate is we do not know but the imagery used suggests is not good: it is cold and dark and has been raining all day:]<br><br>a cold, slanting rain with a wind that bent the trees and sent their surviving leaves up-sky in showers, wheeling like crows<br><br>[The abrupt break in the fragment leaves us wondering just what this confrontation with the father entails… {90} Having incorporated the same idea into his early fiction, written in his teens and known as Text A, we again see the dominant image of the Ulster landscape exerting its influence. The young protagonist in the fragment describes the allure of the surrounding Holywood Hills, and the distant Mourne mountains]<br><br>source of all my dreams perhaps even to this day<br><br>[and questions the ability of the artist to]<br><br>recapture that strange longing, that discontent…?",
        type: "Prose",
        notes: null
    },
    {
    ...
    },
    {
        ...
        issueOrVolume: "vol. 1",
        pageRange: "43-45 and 47",
        year: 2001,
        monthAndDay: null,
        textProvided: "[{43} Lewis made a list of words or phrases in the play and titled it]<br><br>Language Places<br><br>[Lewis also made a list of editorially significant passages and titled it]<br><br>textual places<br><br>[{44}]<br><br>More important than anything else about Othello is his blackness.<br><br>We must concentrate with a primitive sharpness of vision on the physical fact: a group of men coming in by torchlight and in the midst of them, monstrous, not to be got over, the staring black face and red lips<br><br>[{45}]<br><br>foaming, furious [Turk]<br><br>chivalrous [Turk]<br><br>The idea is fascinating . . . a vague picture of unknown and possibly dangerous splendour.<br><br>The creature is noble in its own way: none the less perilous or mysterious for that.<br><br>[This] is the impression which he counts on in the minds of his audiences.<br><br>[{47} Lewis says that Jacobean audiences could not have perceived Othello]<br><br>with contempt or disgust<br><br>[because at that moment in European history]<br><br>there was no imperialism to make men think of them as members of subject races.<br><br>[Lewis’s references to Othello include:] <br><br>the Black Man<br><br>a figure<br><br>object<br><br>a thing<br><br>the creature<br><br>monstrous<br><br>the staring black face and red lips<br><br>blackamore with his flash of tooth and eye<br><br>[Lewis refers to Desdemona as]<br><br>a girl who married a sort of ogre or hobgoblin<br><br>[Lewis refers to Othello and Desdemona’s relationship as]<br><br>The Beauty and the Beast<br><br>[though he adds]<br><br>I do not mean that Shakespeare makes no more of it than that",
        type: "Prose",
        notes: null
    },
    {
    ...
    },
    {
        ...
        year: 2003,
        monthAndDay: null,
        textProvided: "[The young C.S. Lewis wrote in this story that a boy had hoarded a special treasure over in a dark corner of his room. If he knelt in that corner, especially on a very]<br><br><br><br>lonely<br><br>[day, he could hear the winds swirling around the innards of the house. His]<br><br>treasure<br><br>[was an uneven stack of papers—songs, plays, and stories. These were everything he had tried to write over his youthful years. Under the papers, now faded with age, were many pictures that he had composed before he knew how to write. As well as his writings and drawings there were other things—paintboxes, plates extracted from boys’ annuals, a small number of forbidden books, and, when funds allowed, cigarettes. This detritus made up the boy’s treasure,]<br><br>my religion: for it was my past, and the past was all I had yet made my own.",
        type: "Prose",
    ...
    },
    {
        ...
        year: 2005,
        monthAndDay: null,
        textProvided: "[{47} On 10 March 1959, just a few weeks after this initial meeting, Lewis sent the Commission’s secretary eleven pages of his]<br><br>suggested revisions of Psalms I-XLI<br><br>[written in his own hand. In his small cursive script, complete with cross-outs and circled footnotes, Lewis considers such things as accuracy, clarity, rhythm, alliteration, and figurative language. In Psalm 11:3 he notes an illogical image. Where Coverdale has “For the foundations will be cast down,” Lewis notes:]<br><br>We can’t have what is already the lowest (foundations) cast <i>down;</i> it’s like talking about falling off the floor<br><br>[(2, n. 2). He suggests]<br><br>If the foundations be removed<br><br>[(2). Though concerned with accuracy, he is not interested in strict literalism. In Psalm 4:8 (subsequently published as 4:7) he prefers]<br><br>as joyful as<br><br>[to the accurate] <br><br><i>more joyful than, </i>which will produce an inferior rhythm <br><br>[(1, n. 1). And of Psalm 19:3 he says:]<br><br>Leave it alone: it is only <i>verbally</i> false to the original<br><br>[(5, n. 1) {52}We glanced earlier at Lewis’s suggestions for Psalms 1-41, submitted in March 1959; later he sent handwritten suggestions for Psalms 67-81 (2 pages) and 84-89 (2 pages). In all three lists his emendations, like Eliot’s, contain plenty of instances in which he says the equivalent of “Keep Coverdale’s wording.” <i>The Revised Psalter</i> (1964) contains at least six retentions of Coverdale recommended by Lewis; three others did not make the final version. One loss is in Psalm 25:4, where Coverdale has “Lead me forth in thy truth, and learn me: for thou art the God of my salvation.” Of course <i>teach</i> is the obvious modern replacement for <i>learn,</i> but Lewis objects:]<br><br>To change <i>learn</i> into <i>teach</i> wd. be pedantic pseudo scholarship. Learn (wh. was good enough for Mr. Badger) will mislead no-one",
        type: "Prose",
        notes: null
    },
    {
    ...
    },
    {
        ...
        year: 2006,
        monthAndDay: null,
        textProvided: "[According to Brown and Hamilton, “The most interesting change from the proof of <i>The Silver Chair</i> was that on page 48, where he tells the reader that the title of the next Narnia book was to be”:]<br><br><i>Narnia of the North</i>",
        type: "Prose",
        notes: null
    },
    {
    ...
    },
    {
        ...
        issueOrVolume: null,
        pageRange: "21 note 2 and 63 note 225",
        year: 2009,
        monthAndDay: null,
    ...
    },
    {
        ...
        printedIn: "Adam Barkman, <i>C.S. Lewis and Philosophy as a Way of Life</i> (Cheshire, CT: Zossima Press)",
        issueOrVolume: null,
        pageRange: "134, 139, 139 note 156, and 362 note 192",
        year: 2009,
        monthAndDay: null,
    ...
    },
    {
        ...
        year: 2010,
        monthAndDay: null,
        textProvided: "[In addition to early drafts of The Magician’s Nephew and The Voyage of the Dawn Treader, there are what appear to be scraps of ideas (a short paragraph or two) about (1) the authority of the church:]<br><br>The fact that we accept the Bible as the authority of the Church does not make the authority of the Church the higher of the two.<br><br>[(2) ideas about time:]<br><br>The idea of time is no more necessarily bound up with change and motion than it is with permanence and rest.<br><br>[(3) the nature of prayer:]<br><br>Why should we tell God in our prayers of necessities He knows already? Because he prefers to hear them from us.<br><br>[(4) ideas reflected in the poem “The Country of the Blind” or chapter three of Miracles when he discusses the differences between an eye and a photo-sensitive spot:]<br><br>One can imagine an isolated community where for some reason was gradually, generation by generation, going blind.",
        type: "Prose",
        notes: null
    },
    {
    ...
    },
    {
        ...
        issueOrVolume: null,
        pageRange: "ii, xvi, xxiv, 34-35, and dust jacket back cover (holographs); 37-123, 139-157, and 171 (odd pages only)",
        year: 2011,
        monthAndDay: null,
        textProvided: false,
        type: "Prose",
    ...
    },
    {
        ...
        issueOrVolume: "no. 1",
        pageRange: "127-129 (holographs of Lewis’s drawings); 58-102, 121-124, 124-130, 131-144, and 145-169 (transcriptions)",
        year: 2015,
        monthAndDay: null,
        textProvided: false,
        type: "Prose",
    ...
    },
    {
        ...
        pageRange: "19 and <a href='https://doi.org/10.55221/1940-5537.1289' target='_blank' rel='noopener noreferrer' class='link-to-text'>online</a>' target='_blank' rel='noopener noreferrer' class='link-to-text'>online</a>",
        year: 2019,
        monthAndDay: null,
    ...
    },
    {
        ...
        printedIn: "Brenton D.G. Dickieson and Charlie W. Starr, “The Archangel Fragment and C.S. Lewis’s World-Building Project” <i>Sehnsucht: The C.S. Lewis Journal</i>",
        issueOrVolume: "vol. 13",
        pageRange: "18 and <a href='https://doi.org/10.55221/1940-5537.1289' target='_blank' rel='noopener noreferrer' class='link-to-text'>online</a>' target='_blank' rel='noopener noreferrer' class='link-to-text'>online</a>",
        year: 2019,
        monthAndDay: null,
        textProvided: "…the children instructing the bears in the smooth field between the river and the <s>rock-wall</s> cliff.",
        type: "Prose",
        notes: ["Reprinted in Joe Ricke, “The Archangel Fragment: Identifying and Interpreting C.S. Lewis’s ‘Cryptic Note,’” <i>Sehnsucht: The C.S. Lewis Journal,</i> vol. 14 (2020), 110 and <a href='https://doi.org/10.55221/1940-5537.1181' target='_blank' rel='noopener noreferrer' class='link-to-text'>online</a>."]
    },
    {
        ...
        year: 2019,
        monthAndDay: null,
        textProvided: "[We know how Jack Lewis felt about Wagner and his northern operas not only from the memories of C.S. Lewis written many years later but also from an essay on Wagner he wrote for class at Cherbourg. Jack called Wagner the]<br><br>great Bayreuth master<br><br>[for he aimed not at writing pretty music but at producing mental feelings and sensations in the hearers that corresponded to the story in the libretto. Young Lewis believed that Wagner’s <i>Tristan and Isolde</i> exceeded anything the world had seen to that point, but it came before his greatest work, the <i>Ring</i> cycle. Jack acknowledged that the great mass of the public did not appreciate Wagner but that the true]<br><br>musical public<br><br>[of which no doubt he was a representative, appreciated Wagner’s music, which was not simply a collection of melodies of varying value but<br><br>the best and truest means of expressing character, scenery and emotion",
        type: "Prose",
        notes: null
    },
    {
        ...
        issueOrVolume: "vol. 13",
        pageRange: "38 notes 19 and 20 and <a href='https://doi.org/10.55221/1940-5537.1290' target='_blank' rel='noopener noreferrer' class='link-to-text'>online</a>",
        year: 2019,
        monthAndDay: null,
        textProvided: "[{28 note 19}: Walter Hooper, in <i>CL</i> 3:1255 note 94, mentions that “Reply to Mr. R” was “a paper originally read to the Socratic Club,” later rewritten and published as “Myth Became Fact.” Hooper was probably referring to Bodleian MS Facs.b.90, fols.114-120, entitled]<br><br>In Reply to Mr. R.<br><br>[with the hand-written subtitle:]<br><br>A Paper read to the Socratic Club.<br><br>[{38 note 20} In the typescript mentioned in the previous note, [A.L.] Rowse’s name appears on fol. 116 in the sentence:]<br><br>For thoughts, as Mr <strike>Rowse</strike> R. said, move with the times<br><br>[with “Rowse” crossed out and replaced by “R.” in Lewis’s hand.]",
        type: "Prose",
        notes: null
    },
    {
        ...
        pageRange: "108, 110, 112, 114, and 119-121",
        year: 2019,
        monthAndDay: null,
        textProvided: "[{108} From ACRP/30, about Coverdale:]<br><br>We were told to keep his words where possible<br><br>[{108} From ACRP/30. In one specific instance, Lewis writes on Psalm 2:8:] <br><br>...we can keep Coverdale; therefore we should<br><br>[{108} Source unclear but probably ACRP/30. On a verse in Psalm 10, Lewis considers the change from <i>wherefore</i> to <i>why</i> to be]<br><br>a wholly gratuitous departure from C.<br><br>[{108} Source unclear but probably ACRP/30. In his written comments on Psalms 19, 20, and 21, Lewis writes about]<br><br>a needless change of C.<br><br>let’s keep C.<br><br>No difference in sense, so let’s keep C.<br><br>[{110} Source unclear. In one note on Psalm 15:5 (verse 4 in the English) Lewis writes about promises:]<br><br>In plain masculine Modern English the only two things you do with a promise are to <i>keep</i> it or <i>break</i> it. (<i>Implementing</i> be damned!).<br><br>[{112} Source unclear. In their discussion of Psalm 102, Lewis comments:]<br><br>In [Coverdale’s] time <i>secure</i> usually meant <i>securus,</i> not ‘safe’ but ‘feeling safe’. cf. <i>Macbeth</i> ‘security is mortals’ greatest enemy.’ <br><br>[{112} Source unclear. Lewis argues that they ought not to state in Psalm 11:3 that the foundations are cast down:]<br><br>We can’t have what is already the lowest (foundations) cast down: it’s like talking about falling off the floor.<br><br>[{112} Source unclear. Lewis comments playfully on the translation of Psalm 104:26:]<br><br>Suggest ‘to take thy pastime with them’ (If the Hebrew is equally tolerant of either, don’t let’s miss this delightful picture. Quite topical, now that we’re teaching dolphins to talk!).<br><br>[Finally, Heck provides two tables comparing the 1928 Psalter with Lewis’s suggested revision and the actual text of the Revised Psalter. What follows is just the second column of these tables, i.e. Lewis’s revisions. In what follows the page number and then the verse of the Psalm is given for each row in the column:]<br><br>[{119} 12:2a] They speak falsely everyone to his neighbour:<br>[{119} 12:6] I will up, saith the Lord, and defend him: I will give him peace as his heart desireth.<br>[{119} 12:8] O Lord preserve and save us: from a corrupt and evil generation.<br>[{119} 12:9b] : wickedness is exalted among the children of men.<br>[{119} 26:1b] : my trust also hath been steadfast in the Lord.<br>[{119} 26:2b] : try out my inward parts.<br>[{119} 26:4] I have not dwelt with sinners: neither have I fellowship with the hypocrites.<br>[{119} 26:9] O let me not be numbered with the transgressors: neither accounted as one of the blood-thirsty.<br>[{119} 26:10b] : and their right hand is full of bribes.<br>[{120} 23:3a] He shall renew my soul:<br>[{120}23:5a] Thou shalt prepare a table before me in the sight of them that trouble me:<br>[{120} 41:2] The Lord preserveth his life and maketh him mighty in the land: neither suffereth he his enemies to eat him up.<br>[{120} 41:3] The Lord comforteth him when he lieth sick: he maketh all his bed in his sickness.<br>[{120} 41:5] Mine enemies account me as one that is at the gates of death: they ask, When shall he die and his name perish?<br>[{120} 41:6] If they come to see me, they dissemble with their talk: of very malice they foretell the things that I fear, and when they go from me they spread the same abroad.<br>[{121} 41:7b] : they prophesy that my end is near.<br>[{121} 41:8] They say, this sickness is unto death: now that he lieth, he shall rise up no more.<br>[{121} 41:11] Then shall I know that thou dost delight in me: and that mine enemy shall not triumph against me.<br>[{121} 41:12] Because of mine innocency thou upholdest me.",
        type: "Prose",
    ...
    },
    {
        ...
        year: 2019,
        monthAndDay: null,
        textProvided: "[On being asked to supply names of people to be notified of his upcoming Studies in Words; Lewis “drafts a list and then vigorously crosses it out, commenting:”]<br><br>Sorry—I thought this was presentation notices! There is no colleague to whom I’d have the face to send an advertisement if I wasn’t giving him the book.",
        type: "Prose",
        notes: null
    },
    {
        ...
        pageRange: "32-79 and <a href='https://doi.org/10.55221/1940-5537.1178' target='_blank' rel='noopener noreferrer' class='link-to-text'>online</a>",
        year: 2020,
        monthAndDay: null,
        textProvided: false,
        type: "Prose",
    ...
    },
    {
        ...
        year: 2021,
        monthAndDay: null,
        textProvided: "[Side 1]<br><br>I am not quite certain why I have been asked to address the people of Iceland, but I do know why I have accepted the invitation. I have done so in order to repay a great debt. If I seem to you in the whole to be talking of things of a very ancient history, you must forgive me. I am trying through you to thank your ancestors.<br><br>My imaginative life almost begins with an awakening to Norse mythology which came when I was about fourteen. [247] When I came to my conception of it, it was then romantic and in many ways erroneous, depending on a period of translation by our English books which could hardly be otherwise. But when years later I began at Oxford to learn your language, I found nothing in my earlier love that had to be thrown away. That language still seems to be one of the sharpest and strongest of humankind, one of the best adapted for carrying out the ideal of the old poets:<br><br>Let your words at the feast be strewn [?],<br>but let them cut like a sword.<br>Let — — still listen to it,<br>and still touch my heart as perhaps no other can.<br><br>This experiment in rhyme is not so uncommon among Englishmen as you might suppose. In every generation since the beginning of the eighteenth century, there have been some who felt a kind of compass needle in them pointing to the North–the essayist and dramatist Sir William Temple, the poet Grey, William Morris. What is the explanation? I do not think it — to point out or kinship by blood and our early connections. All that, of course, is true. We too are a Baltic people. Our first great poem, Beowulf, celebrates Danish heroes. We had Norsemen as kings, but blood explains little. I myself am of Welsh descent, and if blood were all, I ought to find my natural food in — —, but in fact, the — is as insipid to me as the other is intoxicating.<br><br>If the northern enchantment caught so many Englishmen, it is because of a real, though subtle, affinity of temper between the two which then informs in addition to blood kinship, —. The affinity is easy to feel but difficult to define. One starting point is the fact, recognized I think by all scholars, that whenever a medieval Englishman translated a French romance, he made it a little less courtly; he brought it a little nearer to earth. The farmyard and the castle are nearer to the English person than to the original. And this compliment runs [248] all through our literature straight down — —, but they are really very earthy people, the vulgar counterpart, England sets on — romance. — — all be heroes — —, but the — — people lies in their peasant — and common —. Whenever — — <br><br>[Side 2 is missing]<br><br>[Side 3]<br><br>But heaven forbid I should mention Dickens only to speak ill of him. His very name recalls me at once to what is perhaps the strongest of all affinities between these two antic [antique?] islands. To speak of Dickens is to think of Bumble the beadle, and that carries our mind at once to a whole crowd of thick-headed magistrates, interfering philanthropists, tyrannical administrators of the Poor Law, and the like. Have you ever noticed the fact that Dickens, in Shakespeare, in Fielding, in the whole range of English literature, a person in petty authority, a minor official hardly ever appears except to be made ridiculous? There seems to be a deep conviction in our minds that the man who carries some wand of office is more likely than other men to be half knave and wholly fool.<br><br>I need not remind you of the similar spirit in Old Icelandic. The very origins of Iceland lie in the impeccable independence of those who went there from Norway because they would not be dragooned at home, would not be brought up to bent and made into a tiny little medieval monarchy on the pattern of the other European countries. I would not like to be hasty in giving this spirit a name. It is not democracy, for it dislikes interfering officialdom in a democratic form of government, at least as much as under any other. It is not in essence the revolutionary spirit. Revolution, in the sense of innovation, is not what it seeks. It generally demands to be left alone and shuts its front door in your face. It is not exactly individualism, for it is quite compatible with the most self-effacing loyalty to a family, a patch of ground, or a chief. But it likes to choose its [249] own chief and to choose him for what he really is: his wisdom, his courage, his beauty, or the fact that he is an old friend. I think it is a little — to admit the claims of high descent than to admit those of official status, because they seem a little more intrinsic to the man. It does not assert the rights of man in the abstract, but the rights of a particular man. In the long run, it can be described as personal realism. It brings every situation between two people back to what those two people really are. If Bumble or Harald Fairhair wants to be treated as the better man, he must show he is the better man. Its favorite formula in our language is, “and who the devil are you, anyway?”<br><br>[Side 4 is missing]",
        type: "Prose",
        notes: null
    },
    {
    ...
    },
    {
        ...
        year: 1988,
        monthAndDay: null,
        textProvided: "[The worst thing about Grandfather Lewis was that he is dirty:] <br><br>allways spitting and smoking ugh!",
        type: "Diary",
    ...
    },
    {
        ...
        year: 1990,
        monthAndDay: null,
        textProvided: "My life during the Xmas holidsas [sic] of 1907 by Jacks or Clive Lewis author of “Building of the Promanad”, “Toyland”, “Living races of Mouse-Land” etc. Dedicated to Miss Maude Scott. I begin my life after my 9th birthday, on which I got a book from Papy and a post-card album from Mamy. I have a lot of enymays...",
        type: "Diary",
    ...
    },
    {
        ...
        year: 2021,
        monthAndDay: null,
        textProvided: "Blunt told me I need not be afraid of Ewing’s competition for the Magdalen Fellowship on the ground of his being a Demy, as it would be decided entirely on your papers.<br><br>[{48 note 26} H.P. Blunt was another Greats man; a ‘Demy’ is a scholarship for Magdalen College, Oxford.]",
        type: "Diary",
        notes: null
    },
    {
    ...
    },
    {
        ...
        printedIn: "Arend Smilde, “Why C.S. Lewis did not become a philosopher: Biographical Introduction” in “C.S. Lewis: Tutor and Lecturer in Philosophy: Philosophical Notes (1924),” eds. Norbert Feinendegen and Arend Smilde, <i>Inklings Studies Supplements</i>",
        issueOrVolume: "no. 2",
        pageRange: "63 note 79 and 69",
        year: 2021,
        monthAndDay: null,
        textProvided: "[{63 note 29} Lewis purchased]<br><br>Mill’s Liberty etc. in the Everyman edition wh. I want for Sandeman<br><br>[{69} One of the last references to the “new version” of Lewis’s “Hegemony of Moral Value” paper:]<br><br>…started to work on a new ending for my paper on mind—the part on Obligation.",
        type: "Diary",
        notes: null
    },
    {
    ...
    },
    {
        ...
        textProvided: "<i>Magdalene College, Cambridge</i> <br>2 December 1962<br><br>Dear Mr. Higgins<br><br>1. Surely I never questioned the “legitimacy” of mythopoeia—only the propriety of classifying the art which it belonged to as “Literature.”<br><br>2. The Narnian books are not as much allegory as supposal. “Suppose there were a Narnian world and it, like ours, needed redemption. What kind of incarnation and Passion might Christ be supposed to undergo <i>there</i>?”<br><br>3. Only after Aslan came into the story—on His own; I never called Him—did I remember the scriptural “Lion of Judah.”[435]<br><br>4. No. I never met Chesterton. I suppose the same affinity which made me like him made us both like Macdonald.<br><br>5. I turned to fairy tales because that seemed the form which certain ideas and images in my mind seemed to demand; as a man might turn to fugues because the musical phrases in his head seemed to be “good fugue subjects.”<br><br>6. When I wrote <i>The Lion</i> I had no notion of writing the others.<br><br>7. Writing “juveniles” certainly modified my habits of composition. Thus (<i>a</i>) It imposed a strict limit on vocabulary (<i>b</i>) excluded erotic love (<i>c</i>) cut down reflective and analytical passages (<i>d</i>) led me to produce chapters of nearly equal length, for convenience in reading aloud. All these restrictions did me great good — like writing in a strict metre. <br><br>Yes. I get wonderful letters from children in U.S.A. and elsewhere. <br><br>Yours sincerely,<br><br>C.S. Lewis",
        type: "Letter",
    ...
    },
    {
        ...
        year: 1985,
        monthAndDay: null,
        textProvided: "[Something of the spirit of informal Anglo-Saxon resides, perhaps, in a note that C.S. Lewis wrote to me in 1953 when I asked him if he had seen some lines of Anglo-Saxon verse printed in the personal column of <i>The Times</i> (9 March) to celebrate the publication of C.L. Wrenn’s edition of <i>Beowulf:</i>]<br><br>Giese. Onions me wisade. God wat þæt ic ne wrat þas word. To heanlic me þinceþ þæt Beowulfes leoþ sie on swincstapole gefæstnod.<br><br>[Burchfield’s translation: “Yes. Onions told me. God knows I did not write these words. It seems to me too shameful that the poem about Beowulf should have been placed in the ‘agony column’.”]",
        type: "Letter",
        notes: null
    },
    {
    ...
    },
    {
        ...
        pageRange: "162 and <a href='http://tolkienandfantasy.blogspot.com/2013/11/five-notes-on-cs-lewis.html' target='_blank' rel='noopener noreferrer' class='link-to-text'>online</a>",
        year: 2010,
        monthAndDay: "Fall/Winter",
    ...
    },
    {
        ...
        issueOrVolume: "vol. 32",
        pageRange: "18 (holograph and translation)",
        year: 2015,
        monthAndDay: null,
        textProvided: "Lewis ceorl hateð gretan Coghill eorl luflice ond freondlice. Habbað me Mullaningas þæt leoþ Dymer ascended þæt þe ic him ær sende, forþon þe hie hit bycgan noldon. Hwæt lufað hie ma þa woruldlican speda þonne þa mærþe þære swœtan lare þa þe God me sealde. Forþam heora earsum is gearcod tintregstol wyrmum ond ator bærum eallum afylled a buton ende. Soþ is þæt nu is ah mæste þearfe rædes þines. Ne wat ic sweotole þa tid þinre sæfore. Fo[r]þon ic þe bebeode þæt þu me write. God ðe gehealde.<br><br>[Translation: Lewis the churl bids greeting to Coghill the earl gladly and in a friendly manner. Mullanings have returned to me the poem Dymer that I sent them recently, for they would not acquire it. Behold, they love worldly success more than the glory of the sweet story that God gave me. Therefore, a torture-seat all full of dragons and venom is prepared for their bare arses forever. Truly I am now in most need of your counsel. I do not know clearly the time of your sea voyage. Therefore I bid you that you write me. God keep you.]",
        type: "Letter",
        notes: null
    },
    {
        ...
        pageRange: "18 (holographs), 21 (transcription)",
        year: 2016,
        monthAndDay: null,
    ...
    },
    {
        ...
        pageRange: "36-37 and <a href='https://doi.org/10.55221/1940-5537.1349' target='_blank' rel='noopener noreferrer' class='link-to-text'>online</a>",
        year: 2016,
        monthAndDay: null,
    ...
    },
    {
        ...
        printedIn: "Gregory M. Anderson, “Lost Letters of Lewis at Lambeth Palace Library,” <i>Sehnsucht: The C.S. Lewis Journal</i>",
        issueOrVolume: "vol. 10",
        pageRange: "40-41 and <a href='https://doi.org/10.55221/1940-5537.1349' target='_blank' rel='noopener noreferrer' class='link-to-text'>online</a>",
        year: 2016,
        monthAndDay: null,
    ...
    },
    {
        ...
        printedIn: "Gregory M. Anderson, “Lost Letters of Lewis at Lambeth Palace Library,” <i>Sehnsucht: The C.S. Lewis Journal</i>",
        issueOrVolume: "vol. 10",
        pageRange: "45-46 and <a href='https://doi.org/10.55221/1940-5537.1349' target='_blank' rel='noopener noreferrer' class='link-to-text'>online</a>",
        year: 2016,
        monthAndDay: null,
        textProvided: "Nov 11th 1946<br><br>Dear Collins—I am really sorry to be a brake or drag on you in this matter: sorry that the mere fact of my not helping makes me a hindrance. There is no disguising from you the truth—that, for good or ill, the whole world of collective action is quite foreign to me: I am, in the Greek sense, the most <i>idiotic</i> man in England. That, much more than proper defects in your draft, may be the reason why I still pullulate with negative criticisms. I really think  you will get on much better without me. But here goes;—<br><br>1. Yes. In some sense. I should be happier if the sentence ended with <i>providence.</i> The other words might imply a sort of Carlylean historicism wh. I doubt—the belief that God’s act can be recognised in that limited part of human experience wh. gets into “history”<br><br>2. “operate”, Yes—in contention with the real “King of <i>this</i> world” “surely” might imply that the justice and love inevitably win even here.<br><br>3. If “determinant” = efficient cause, I doubt this. I shd. feel happier in saying that “in all collective behaviour self interest is the chief determinant”<br><br>4. Danger of not <i>perfectly</i> sincere humility. There are surely a great many elements in the “total situation” for which some people present bear <i>no</i> individual responsibility?<br><br>5. I didn’t even know what organisations you refer to. And I suspect that many people (of whom I am one) wd. simply reduce this utility by attempting to be working members of any of them.<br><br>6. Shouldn’t you add “and to meet with implacable resistance, regardless of self interest, any attempt to curtail human freedom, to prevent private charity, or to lend a pseudo-Xtian colouring to secular undertakings”.<br><br>7. Any serious attempt to do this wd. be out of the question for me. I hope I am not inventing difficulties as an excuse for keeping out of something I ought to be in. (Quite literally) God knows! I <i>seem</i> to myself<br><br>a. Really to see these difficulties<br>b. To want (and, for me, <i>rightly</i> to want) not to commit myself to something in wh. I am sure it is not <i>my</i> vocation to participate.<br><br>I am very sorry, <br>Yours<br>C.S. Lewis",
        type: "Letter",
    ...
    },
    {
        ...
        pageRange: "20 and <a href='https://doi.org/10.55221/1940-5537.1378' target='_blank' rel='noopener noreferrer' class='link-to-text'>online</a>",
        year: 2017,
        monthAndDay: null,
    ...
    },
    {
        ...
        printedIn: "Gregory M. Anderson, “Lewis, Lost Letters, and Love,” <i>Sehnsucht: The C.S. Lewis Journal</i>",
        issueOrVolume: "vol. 11",
        pageRange: "22-23 and <a href='https://doi.org/10.55221/1940-5537.1378' target='_blank' rel='noopener noreferrer' class='link-to-text'>online</a>",
        year: 2017,
        monthAndDay: null,
    ...
    },
    {
        ...
        printedIn: "Gregory M. Anderson, “Lewis, Lost Letters, and Love,” <i>Sehnsucht: The C.S. Lewis Journal</i>",
        issueOrVolume: "vol. 11",
        pageRange: "24-25 and <a href='https://doi.org/10.55221/1940-5537.1378' target='_blank' rel='noopener noreferrer' class='link-to-text'>online</a>",
        year: 2017,
        monthAndDay: null,
    ...
    },
    {
        ...
        year: 2017,
        monthAndDay: "October",
        textProvided: "The Kilns, Headington Quarry, Oxford <br>6 Sept 59<br><br>Dear Mr. Fairhurst<br><br>I parted company from MacDonald on that point because a higher authority—the Dominical utterances themselves—seemed to me irreconcilable with universalism. The finality of the Either-Or, the Sheep and Goats, the Wheat and Tares, the Wise and Foolish Virgins—is so emphatic and reiterated in Our Lord’s teaching that, in my opinion, it simply cannot be evaded. If we do not know that He said that, then we do not know what He said about anything. And this my sole reason. So far as I know my views on the retributive element in human punishments went for nothing here. Need I add that I shd. v. much prefer to follow G.M. in this point if I could? <br><br>Yours sincerely,<br><br>C.S. Lewis<br>P.T.O.<br><br>P.S. I don’t know the answer about Maurice. The <i>Life</i> of G.M. by his son, Dr. Greville MacDonald (not a very good book) would very likely tell you.",
        type: "Letter",
        notes: null
    },
    {
        ...
        year: 2017,
        monthAndDay: "October",
        textProvided: "The Kilns, Headington Quarry, Oxford<br>9 Sept 1959<br><br>Dear Mr. Fairhurst—I would very fully agree with your view that Our Lord’s teaching is directed to influencing our will rather than to satisfying our curiosity. Nor do I think it commits us to all the later pictures of the “tortures” of Hell. If I remember rightly, the word κόλασις is used only once. The regular emphasis is on the <i><u>finality</u></i> of rejection or exclusion—on the negative, not on any positive, aspect of damnation. If we stick to the Dominical language, the dust-bin or rubbish-heap image is perhaps more prominent than the prison image.<br><br>Yours sincerely<br><br>C.S. Lewis<br><br>P.S. To picture the foolish virgins in perpetual torment is perhaps just as blunderingly pro­saic as to picture the wise ones as perpetually at supper! Both are prosaic, therefore false, extensions of the real poetic image which simply seizes the moment of ‘Come inside’ or ‘Go away’?",
        type: "Letter",
    ...
    },
    {
        ...
        year: 2007,
        monthAndDay: null,
        textProvided: "March 1931<br><br>My dear Harwood,<br><br>I am instructed to inform you that at a meeting of the walk committee held yesterday in the rooms of the Union Society Oxford, the following resolutions were passed:<br><br>1. That Mr. A.C. Harwood be created Lord of the Walks, with all feudalities appertaining thereto: i.e. <i>sac</i> and <i>soc, corvée, jus primae noctis</i> vel romanice, <i>droit de seigneur,* jus impune guitandi,</i> the high justice, the middle and the low.<br><br>2. That a petition be presented to the said Lord of the Walks on behalf of us his vassals, requesting permission to commute the said feudalities for rent or money payment: the said vassals to be declared, in return, free and delivered from all such services as the said feudalities imply. It is estimated that the said rent would amount to a sum between £5 and £6; the denomination of the said sum, notwithstanding, to rest in the last resort with the said Lord.<br><br>3. That the following resolution in rescript of the Sub-Committee for ethical problems be forwarded to the said Lord: “That it is the moral duty of the Lord of the Walks to grant the petition of his vassals for the commutation of his feudalities.”<br><br>4. That the Walk shall begin on the morning of Friday April 17th from Hay: and shall return to Hay through Builth, Rhayader, and New Radnor.<br><br>5. That the said Lord be humbly requested to notify his pleasure in this matter to the committee at his earliest convenience.<br><br><i>In nomine sanctae et individui trinitatis.</i><br><br>Of <i>course</i> you’ll come. Hoity toity. What has that Captain Field been about not to leave a period open.<br><br>Yrs.<br>C.S. Lewis.<br><br>* N.B. The said Lord, however, shall have no right to command the marriage of any of his vassals during the Walk.",
        type: "Letter",
    ...
    },
    {
        ...
        year: 2006,
        monthAndDay: null,
        textProvided: "16 October 1940<br><br>My dear Barfield, <br><br>A book on this subject from me at Oxford (wh. continues to be Gideon’s fleece) to you in the front line seems rather impertinent. When wd. you like a few quiet nights here? Do come and spend one or two. You are daily in my thoughts. <br><br>Yours,<br>C.S. Lewis",
        type: "Letter",
        notes: null
    },
    {
    ...
    },
    {
        ...
        year: 2002,
        monthAndDay: null,
        textProvided: "[Referring to Sir Henry Thomas Tizard (President of Magdalen College 1942-1946):]<br><br>He doesn’t turn up at weekday chapels, and it’s not very easy to ask him a direct question. But I’ll keep my eyes and ears open.",
        type: "Letter",
        notes: null
    },
    {
    ...
    },
    {
        ...
        year: 1999,
        monthAndDay: null,
        textProvided: "[A former student of Lewis, Sniders, now a prisoner of war in German custody, received a parcel from his wife including  “books on the advice of C.S. Lewis, and she enclosed a copious list he had given her in longhand of further books to be ordered or read from the camp library of the Red Cross. He said that if I read them all”]<br><br>the rest would just be top dressing<br><br>[“when I worked for my degree after the war.”]",
        type: "Letter",
        notes: null
    },
    {
    ...
    },
    {
        ...
        year: 2003,
        monthAndDay: null,
        textProvided: "[Significantly, on an occasion when he longed to visit Northern Ireland but was confined by the illness of an aging Mrs. Moore, he spoke in a letter of Ulster as his]<br><br>ain countrie<br><br>[thinking of the hills of County Down and the coastline of County Antrim.]",
        type: "Letter",
        notes: null
    },
    {
        ...
        year: 1986,
        monthAndDay: null,
        textProvided: "All Saints’ Day<br><br>My dear Owen<br><br>Thanks for long letter from lady. I don’t know about a poem I haven’t seen whose subject as stated in your letter I can’t read. But she sounds a good object for £100 from Agapony, and if you think proper, will you send it.<br><br>Perhaps Mr. Micawber & Atlas are “ultimately” the same (amazing paradox!)<br><br><i>Much-Bearer</i> = OE<br><i>Michel-bera</i><br>>Micebber<br>>Micabber<br>>Micawber<br>(cf. further loss of L, <i>calf</i> etc).<br><br>Yrs Jack<br><br>(By metathesis, Mulciber. L = POS. Everything is everything.) Inquire further into relation with √MACHABEE<br>On 17<sup>th</sup> go straight to Royal Oxford Hotel (outside Magdalen station) where you’ll find us from 7 p.m. on.",
        type: "Letter",
    ...
    },
    {
        ...
        year: 1986,
        monthAndDay: null,
        textProvided: "Magdalen College, Oxford <br>Nov 8/54<br><br>Dear Owen<br><br>Miss Margaret Radcliffe (Tree Top, Hindhead, Surrey) has had an operation and been in hospital for 4 weeks at 4-4-1 a week; and you know her income. Cd. you send her 21?<br><br>yours<br> Jack",
        type: "Letter",
    ...
    },
    {
        ...
        year: 1973,
        monthAndDay: null,
        textProvided: "Magdalen College, Oxford <br>Nov. 22d 1947<br><br>Dear Mrs Williams<br><br>I was most delighted to get your kind letter and to find that you approved of the Memoir, and that you feel as we all do about the “liquorice halo”; not only, or even chiefly, because one doesn’t like liquorice (tho’ that comes in too) but because it obscures the real halo.<br><br>Thank you very much. It will be a great pleasure to see you at Oxford when you are free! I am glad you are comforting old Mrs. Williams and can also sympathise as most of my private life is framed in a similar task. With very many thanks and good wishes,<br><br>yours sincerely<br>C.S. Lewis",
        type: "Letter",
        notes: null
    },
    {
    ...
    },
    {
        ...
        year: 2006,
        monthAndDay: null,
        textProvided: "REF.321/49. <br>Magdalen College, Oxford.<br>14th July 1949.<br><br>Dear Mr. Kennedy,<br><br>I am leaving Oxford tomorrow, and shall be to and fro for a bit. Will you be here after August 15<sup>th</sup>? I should find it easier to arrange a meeting then.<br><br>Yours sincerely,<br><br>C.S. Lewis",
        type: "Letter",
        notes: null
    },
    {
    ...
    },
    {
        ...
        textProvided: "[Inviting him and her husband with others for a lunch including Marjorie Milne:]<br><br>…who’s been reading <i>Oedipus</i> and would be thrilled to meet Colin.",
        type: "Letter",
        notes: null
    },
    {
    ...
    },
    {
        ...
        issueOrVolume: null,
        pageRange: "<a href='https://wng.org/roundups/dear-ladies-1617227368' target='_blank' rel='noopener noreferrer' class='link-to-text'> online</a>",
        year: 2018,
        monthAndDay: null,
        textProvided: "Dear Ladies,<br><br>Who told you that Christians must not go to the theatre, dance, play cards, drink, or smoke? The “World,” you will remember, is mentioned along with the flesh and the devil. The Flesh means sexual vice (but not marriage), drunkenness (but not drinking) enslave­ment to indulgent habits (but not ××××××, not smoking just as much) and over-eating (but not enjoying one’s meals). The Devil means occultism and magic in all their various forms (spiritualism, astrology, future-telling, avoiding 13, not walking under ladders). The World means worldly ends and ambition (inordinate interest in one’s career, love of money, snob­bery, desire to be in the right set, desire for popular­ity). Of course <i>any</i> of the innocent pleas­ures may have to be given up in a particular extreme: e.g. cards must go if you can’t play without becoming totally absorbed in it and drink must go if you can’t drink without taking too much. But a list of general prohibitions such as you suggest is not in the spirit of Chris­tianity at all: it is more like the old Jewish law, from which, as St. Paul says, we are ‘set free’. The test of an <i>innocent</i> pleasure is whether you can with a clean mind give God <i>thanks</i> for it—as I cer­tainly can for a glass of beer on a hot day but can <i>not</i> for being drunk: can be con­tended without it. It is not the pleasure but the enslavement to an act is bad. I don’t myself know of a particular actor who has been converted—how shd. I—just as I don’t happen to know of a particular postman who has. But I don’t think that means that I must’ve lost the letter. You write again if I haven’t been clear: meanwhile, all good wishes.<br><br>Yours sincerely,<br>C.S. Lewis",
        type: "Letter",
        notes: null
    },
    {
    ...
    },
    {
        ...
        year: 2000,
        monthAndDay: null,
        textProvided: "I […] admire the XIXth century more than almost any other period.<br><br>[On the book Pitter and Barfield had both recommended:]<br><br>…not more able to read it than I can read <i>Childe Harold</i>.",
        type: "Letter",
        notes: null
    },
    {
    ...
    },
    {
        ...
        issueOrVolume: null,
        pageRange: "3 and <a href='https://trove.nla.gov.au/newspaper/article/85533078?browse=ndp%3Abrowse%2Ftitle%2FM%2Ftitle%2F280%2F1952%2F02%2F28%2Fpage%2F7746971%2Farticle%2F85533078' target='_blank' rel='noopener noreferrer' class='link-to-text'> online</a>",
        year: 1952,
        monthAndDay: "28 February",
        textProvided: "Thank you for sending me your article, which is at once terrifying and consoling, and always of absorbing interest. Alas! I do not find any of it “inconceivable”. I wish it were more widely known to the fools in the free countries who still rally with Bolshevism.<br><br>With all good wishes to yourself, yours sincerely,<br><br>C.S. Lewis.",
        type: "Letter",
    ...
    },
    {
        ...
        year: 1985,
        monthAndDay: "September",
        textProvided: "[Lewis declines because his interests were]<br><br>decreasingly in that period. I was very tired of the 16<sup>th</sup> century before I finished my book.",
        type: "Letter",
        notes: null
    },
    {
    ...
    },
    {
        ...
        year: 1964,
        monthAndDay: null,
        textProvided: "The reason why the Passion of Aslan sometimes moves people more than the real story in the Gospels is, I think, that it takes them off their guard. In reading the real story the fatal knowledge that one <i>ought</i> to feel in a certain way often inhibits the feeling.",
        type: "Letter",
        notes: null
    },
    {
    ...
    },
    {
        ...
        year: 2007,
        monthAndDay: null,
        textProvided: "The Kilns, Headington Quarry, Oxford<br>10 Sept 62<br><br>Dear Laurence,<br><br> (Yes, I’d much rather be called Jack. And also, like you, I’ve never discovered the plural of <i>syllabus</i>. Like <i>rhinoceros</i> and <i>genius,</i> it has “a thing about” its plural).<br><br>Your letter was not long-winded but heroic—for I know what dull work it is writing a long, clear account of what one already knows. Our present objective for Douglas is merely G.C.E. as a preliminary for Christmas.<br><br>A thousand thanks. <br><br>Yours,<br>Jack",
        type: "Letter",
        notes: null
    },
    {
    ...
    },
    {
        ...
        year: 1981,
        monthAndDay: null,
        textProvided: "[Shortly before Lewis died in 1963, it was proposed by a literary agent and a publisher in London that a book about heresies should be commissioned. Lewis was consulted and gave his blessing not only to the project, but also more rashly, to myself as its proposed author:]<br><br>For this book he would be ideal.<br><br>[But he qualified this endorsement in a very pointed way.]<br><br>Would a limitation, say down to 1400, be a good plan, so that it can remain a historical fact book and not become controversial?",
        type: "Letter",
        notes: null
    },
    {
        ...
        year: 2005,
        monthAndDay: null,
        textProvided: "[About enjoying the work on the Commission to revise the Psalter:]<br><br>…we were a wonderfully happy family. I have seldom enjoyed anything more.",
        type: "Letter",
    ...
    },
    {
        ...
        year: 1988,
        monthAndDay: null,
        textProvided: "…like reading a Mozart libretto seriously: a blood-curdling experience.",
        type: "Letter",
        notes: null
    },
    {
        ...
        year: 2002,
        monthAndDay: null,
        textProvided: "Have been reading <i>Les liaisons dangereuses</i>. Wow what a book! Come to lunch on Friday (fish) and tell me about it.",
        type: "Letter",
        notes: null
    },
    {
    ...
    },
    {
        ...
        year: 2009,
        monthAndDay: "April",
        textProvided: "[The letter, apart from being labeled]<br><br>Sunday<br><br>[is not dated, but in it, Lewis indicates an interest that Barfield come to Headington]<br><br>that I may show you our new domain",
        type: "Letter",
        notes: null
    },
    {
    ...
    },
    {
        ...
        printedIn: "Arend Smilde, “C.S. Lewis’s ‘Transposition’: Text and Context,” <i>Sehnsucht: The C.S. Lewis Journal</i>",
        issueOrVolume: "vol. 13",
        pageRange: "37 note 16 and <a href='https://doi.org/10.55221/1940-5537.1290' target='_blank' rel='noopener noreferrer' class='link-to-text'>online</a>",
        year: 2019,
        monthAndDay: null,
    ...
    //     issueOrVolume: null,
    //     pageRange: "<a href='https://mereorthodoxy.com/when-the-story-stops-telling-itself-a-new-letter-from-c-s-lewis' target='_blank' rel='noopener noreferrer' class='link-to-text'>online</a> only",
    //     year: 2013,
    //     monthAndDay: "27 August",
    //     textProvided: "The Kilns, Headington Quarry, Oxford<br>July 31, 1957<br><br>Dear Sarah Hauser,<br><br>I am delighted to hear that you like the Narnian books and it was nice of you to write and tell me. There won’t be any more. When the story stops telling itself to me, I have to stop telling it to other people: if I tried to go on it would only sound forced and dull.<br><br>With all good wishes,<br>Yours,<br>C.S. Lewis",
    //     type: "Letter",
    //     notes: null
    // },
    {
    ...
    },
    {
        ...
        printedIn: "Charlie W. Starr and Crystal Hurd, “Lewis Manuscripts at Lanier Theological Library,” <i>Sehnsucht: The C.S. Lewis Journal</i>",
        issueOrVolume: "vol. 15",
        pageRange: "39 and <a href='https://doi.org/10.55221/1940-5537.1086' target='_blank' rel='noopener noreferrer' class='link-to-text'>online</a>",
        year: 2021,
        monthAndDay: null,
    ...
    },
    {
        ...
        printedIn: "Charlie W. Starr and Crystal Hurd, “Lewis Manuscripts at Lanier Theological Library,” <i>Sehnsucht: The C.S. Lewis Journal</i>",
        issueOrVolume: "vol. 15",
        pageRange: "42 and <a href='https://doi.org/10.55221/1940-5537.1086' target='_blank' rel='noopener noreferrer' class='link-to-text'>online</a>",
        year: 2021,
        monthAndDay: null,
        textProvided: "7<br><br>lower level, as a pleasant “sentimental journey” I like it very well. The part about Sicily is really very jolly: and I like your monk with whom you had the drink. I should think it will be very successful: without prejudice to a severer work  [the words “and more” are crossed out after the word “work”] on the same subject later on. I will leave the gallies in my rooms in Magdalen and you can fetch them thence if I am out. Come up here and see me some afternoon. With many thanks<br><br>Yours<br>C.S. Lewis",
        type: "Letter",
    ...
    },
    {
        ...
        printedIn: "Charlie W. Starr and Crystal Hurd, “Lewis Manuscripts at Lanier Theological Library,” <i>Sehnsucht: The C.S. Lewis Journal</i>",
        issueOrVolume: "vol. 15",
        pageRange: "46 and <a href='https://doi.org/10.55221/1940-5537.1086' target='_blank' rel='noopener noreferrer' class='link-to-text'>online</a>",
        year: 2021,
        monthAndDay: null,
    ...
    },
    {
        ...
        printedIn: "Charlie W. Starr and Crystal Hurd, “Lewis Manuscripts at Lanier Theological Library,” <i>Sehnsucht: The C.S. Lewis Journal</i>",
        issueOrVolume: "vol. 15",
        pageRange: "47 and <a href='https://doi.org/10.55221/1940-5537.1086' target='_blank' rel='noopener noreferrer' class='link-to-text'>online</a>",
        year: 2021,
        monthAndDay: null,
    ...
    },
    {
        ...
        printedIn: "Charlie W. Starr and Crystal Hurd, “Lewis Manuscripts at Lanier Theological Library,” <i>Sehnsucht: The C.S. Lewis Journal</i>",
        issueOrVolume: "vol. 15",
        pageRange: "48 and <a href='https://doi.org/10.55221/1940-5537.1086' target='_blank' rel='noopener noreferrer' class='link-to-text'>online</a>",
        year: 2021,
        monthAndDay: null,
    ...
    },
    {
        ...
        printedIn: "Charlie W. Starr and Crystal Hurd, “Lewis Manuscripts at Lanier Theological Library,” <i>Sehnsucht: The C.S. Lewis Journal</i>",
        issueOrVolume: "vol. 15",
        pageRange: "49 and <a href='https://doi.org/10.55221/1940-5537.1086' target='_blank' rel='noopener noreferrer' class='link-to-text'>online</a>",
        year: 2021,
        monthAndDay: null,
    ...
    },
    {
        ...
        printedIn: "Charlie W. Starr and Crystal Hurd, “Lewis Manuscripts at Lanier Theological Library,” <i>Sehnsucht: The C.S. Lewis Journal</i>",
        issueOrVolume: "vol. 15",
        pageRange: "50 and <a href='https://doi.org/10.55221/1940-5537.1086' target='_blank' rel='noopener noreferrer' class='link-to-text'>online</a>",
        year: 2021,
        monthAndDay: null,
    ...
    },
    {
        ...
        printedIn: "Charlie W. Starr and Crystal Hurd, “Lewis Manuscripts at Lanier Theological Library,” <i>Sehnsucht: The C.S. Lewis Journal</i>",
        issueOrVolume: "vol. 15",
        pageRange: "51 and <a href='https://doi.org/10.55221/1940-5537.1086' target='_blank' rel='noopener noreferrer' class='link-to-text'>online</a>",
        year: 2021,
        monthAndDay: null,
    ...
    },
    {
        ...
        printedIn: "Charlie W. Starr and Crystal Hurd, “Lewis Manuscripts at Lanier Theological Library,” <i>Sehnsucht: The C.S. Lewis Journal</i>",
        issueOrVolume: "vol. 15",
        pageRange: "52 and <a href='https://doi.org/10.55221/1940-5537.1086' target='_blank' rel='noopener noreferrer' class='link-to-text'>online</a>",
        year: 2021,
        monthAndDay: null,
    ...
    },
    {
        ...
        printedIn: "Charlie W. Starr and Crystal Hurd, “Lewis Manuscripts at Lanier Theological Library,” <i>Sehnsucht: The C.S. Lewis Journal</i>",
        issueOrVolume: "vol. 15",
        pageRange: "53 and <a href='https://doi.org/10.55221/1940-5537.1086' target='_blank' rel='noopener noreferrer' class='link-to-text'>online</a>",
        year: 2021,
        monthAndDay: null,
    ...
    },
    {
        ...
        textProvided: "Magdalen College, Oxford<br>Nov. 23 / 54<br><br>Dear Joan,<br><br>I am haunted by a feeling that I have been asked to a big tea-fight next Mon. before my lecture, but can find nothing about it in my files. As you and Stanley [Bennett] wd. almost certainly be asked, can you tell me? (I’m <i>not</i> mixing it up with a sherry-party <i>after</i> the lecture given by [Basil] Willey). Oh dear, what a scrape! Not being one yourself, you can’t imagine how difficult life is if one is a fool!<br><br>Yours<br>C.S. Lewis<br><br>P.S. Reply at Magdalen<u>e</u> will find me from to-morrow.",
        type: "Letter",
        notes: null
    },
    {
    ...
    },
    {
        ...
        year: 2023,
        monthAndDay: null,
        textProvided: "The Kilns, Headington Quarry, Oxford<br>23/9/55<br><br>Dear Shephard [sic] (If we may drop the honorifics)<br><br>Thanks for yours of 17<sup>th.</sup> & enclosure. I’ve nothing to add to it except perhaps this; that references to other works shd. be work­able for cheap texts as well as scholarly editions where both exist (e.g. reference to Malory shd. give Caxton’s Bk & cap. & Every­man vol. & p. as well as Vinaver). On p. 2. para. 5. per­haps for <i>In all other…chosen</i> read <i>so far as this limitation of length permits</i>, ? The text as it stands is a bit clumsy.<br><br>Yours<br>C.S. Lewis",
        type: "Letter",
        notes: null
    },
    {
        ...
        year: 2023,
        monthAndDay: null,
        textProvided: "Magdalene College, Cambridge<br>6/10/55<br><br>Dear Shepherd (we can drop the honorifics on both sides, can’t we) I think the four texts chosen cd. be a v. good kick-off. You’ll tell me later what, roughly, you want me to say in the General Introduction.<br><br>For later use: I hope we shall be able to do <i>Squire Meldrum</i> which is such good reading that it might have a role even outside students & scholars. And is there any chance of capturing the market now catered for by the Orchard Books, with one of his devotional treatises? The Orchard new denominations are not too good.<br><br>Yours<br>C.S. Lewis",
        type: "Letter",
        notes: null
    },
    {
        ...
        year: 2023,
        monthAndDay: null,
        textProvided: "Magdalene College, Cambridge<br>15/11/55<br><br>Dear Shepherd<br><br>Thanks. Good. Sat. Dec. 10th; Eastgate, Oxford 11. A.M.? I shall assume this unless I hear to the contrary,<br><br>Yours<br>C.S. Lewis",
        type: "Letter",
        notes: null
    },
    {
        ...
        year: 2023,
        monthAndDay: null,
        textProvided: "Magdalene College, Cambridge<br>17/1/58<br><br>Dear Shepherd<br><br>Oh I’ll read the Introduction alright: I’d thought it was a question of going through the text and notes word by word!<br><br>Yours<br>C.S. Lewis",
        type: "Letter",
        notes: null
    },
    {
        ...
        year: 2023,
        monthAndDay: null,
        textProvided: "The Kilns, Headington Quarry, Oxford<br>17/3/58<br><br>Dear Shephard—It is perhaps almost an advantage that I came to your introduction know­ing almost nothing about this text. This enabled me to gauge how clear you were making things—for of course all expositions seem easy if we start by knowing what is expounded. Frankly, I don’t think your pp. 2-6 are as lucid as they ought to be and can, no doubt, be made by re-writ­ing. First of all one is started on a false trail by version. Then comes the absolute mystery at the bottom of p. 5. “Agreement between MSS” usually means agreement in readings be­tween MSS of the same work. “Agreement in content” doesn’t clear matters up. No one expected them to agree in shape or size? Nor is the student given any hint why SK, SM etc. are being mentioned at all. Could you not use a good many more words making clear what you are going to tabulate and <i>why</i> before you go on to the tabulation? And wd. the earlier part run more easily in the order<br><br>1. This work exists in English, French and Latin.<br>2. Descriptions of the English MSS<br>3. ——————————  French MSS	if, and so far as, necessary [in the MSS this note is applied both to this and to the next numbered item by an arrow or brace]<br>4. ——————————  Latin MSS<br>5. But there is evidence that the English is the original<br>6. It will be necessary for the following reasons to mention other works<br>7. About SK, SM etc.<br>I am probably being stupid, but some of your other readers may be so too. After that, you got much easier. I enclose my notes, of very varying importance. If you revise (but you ought to let someone else vet it too) I suggest that changes shd. be all in the di­rec­tion of simpler (and there­fore more elegant) syntax and always the most precise or most obvious word. Often, see <i>object</i> for <i>substance</i> on p. 45 these coincide. Perhaps I should add that I have a severe cold in my head and some of my discontents may arise fm that, not fm you!<br><br>Yours<br>C.S. Lewis<br><br>P. 1 Para 1. <i>Self-inflicted pain</i>. True, but perhaps misleading. Does he not restrain rather than incite in this direction.<br><i>to us</i>, well of course. Perhaps most of your readers, however, need more to be reminded that this sort of life is still being attempted—is a perennial, not a “period,” thing.<br>Para 2 <i>new</i>. I suppose this will be gone into later?<br>P. 2. Para 1. last line. <i>various</i>. This leads one to think it was written in Latin or French and the Eng. texts are translations. Then, when in l. 4. one finds the French and Latin also called <i>versions</i> one gets puzzled. (For <i>versions</i> in l. 3 read MSS? For <i>versions</i> in l. 4, read <i>translations</i>? If that is what is meant).<br>P. 4 Para. 4. <i>texts</i>. Again, the precise sense of the word is not absolutely clear.<br>Para 5 <i>However there can</i>. I shd. prefer (a) <i>But there can</i> (b) <i>There can, however</i>,<br>Pp. 5-6. Not at all easy to follow. Oughtn’t Ste, st. etc. to have a new para. and a sentence explaining why they are being introduced? I think this whole bit shd. be re-written with the needs of a reader starting from scratch in view.<br>P. 17 <i>cannot be extended indefinitely</i>. I don’t know what this means. We have been given not an argument but a hypothesis. Do you mean “is not v. probable” or “does not cover all the facts,” or what?<br>P. 18. Para. 2. Last sentence. <i>But indeed</i>. The transition of thought implied by this is not clear to me.<br>P. 19. Para. 2. <i>far into the 13<sup>th</sup></i>. Does this mean “well within”? I understand a thing “lasting (or continuing, or penetrating) <i>far into</i> a century” but hardly “referring far into”<br>P. 21 l. 2. <i>shall</i>. Surely <i>will</i>?<br>P. 26. Para 2. <i>Curzon to become</i>. Morally??? English?<br>P. 30 ll. 4-8. Cd. we say this with fewer as’s? (probably, pirate as much as merchant”?)<br>P. 31. Para 2. Is <i>later times</i> a good antithesis to <i>month</i>?<br>P. 32. Para 2. <i>cloud of witnesses</i>. A trifle hackneyed, and anyway a recluse can be a witness only in a <i>very</i> “spiritual” sense.<br>P. 35. Para 2. <i>prescribes of</i>. A rather harsh construction. “Lays down rules for … for … and for”?<br>Last line <i>as in the case of</i>. Wouldn’t <i>like</i> be more English?<br>P. 39. Para 2. <i>scrupulously</i>. Am I pedantic in feeling that when we are writing about a theo­log­ical matter we must not use this word in its popular sense? I’d feel happier with <i>strictly</i>, or <i>exactly</i>.<br>P. 43. Para 2. <i>a kind of insertion</i>. Is this v. unlike the account of Adam’s creation in <i>Gene­sis</i>?<br>P. 45. Para 2. <i>Puritanism</i>. If we must use the word in this sense let us at least give it in­verted commas (and perhaps a footnote to say that this has v. little connection, if any, with historical Puritanism (e.g. Cartwright). We must not <i>encourage</i> misconceptions.<br>5th l. from end. <i>substance</i>. Don’t you mean <i>object</i>?<br>P. 46. Para 2. Shd. we note that Anselm is pretty close (on a far more popular level) to Boethius in this?<br>P. 55. Memo—it all occurs in Islamic mysticism too, doesn’t it? But perhaps we can let that sleeping dog lie.<br>P. 57. Para 2. l. 5. <i>Divine person</i>. As we are going on to what concerns especially the human­ity of Christ, is the word <i>divine</i> here something of a Red Herring?<br>P. 58. Para 2. <i>And Bernard</i>. Wd. either <i>But Bernard</i>, or simply <i>Bernard</i> do more justice to the actual movement of your thought?<br>P. 61 l. 8. <i>correlate</i>. Is this any improvement on <i>object</i>?<br>P. 62 para 1. <i>acquired …. interchangeable</i>. I have no idea what this means.<br>P. 63 para 2. l. 10. <i>egocentric love is deepened</i>. This surely wd. naturally mean the v. oppo­site of what you intend, i.e. that we love ourselves simply (quantitatively) <i>more</i> & therefore love God and our neighbour less. You can’t say all you want to in so few words.<br>P. 69. para. 2. l. 9. <i>He aims beyond mere assent</i>. Wd. “he aims at something more than mere assent” be easier?<br>Last sentence. I am not quite sure what you mean. Do you mean that when people come to analyze they are puzzled by something that did not puzzle them as readers? Or that some transitions are difficult to represent in an analysis? Or that those who read analyses are puzzled?<br>P. 71. para 2. L. 2. <i>emerges from its dependence</i>. Does this mean <i>1.</i> Comes to light by rea­son of its dependence on or <i>2.</i> ceases to depend on?",
        type: "Letter",
        notes: null
    },
    {
        ...
        year: 2023,
        monthAndDay: null,
        textProvided: "The Kilns, Headington Quarry, Oxford<br>22/3/58<br><br>Dear Shepherd—I must have expressed myself badly if you think I condemned your “man­ner of writing” as “irritating”. I objected in one place not to your manner but to your <i>ordon­nance</i> as need­lessly difficult. I object to “substance” (of a desire or hope—I forget which it was) be­cause I don’t know what it means. Is it the thing hoped for or desired? if so, surely more peo­ple wd. under­stand “object”? Is it the “substance” of this hope or desire as distinct from its accidents? If so—<i>tantamne rem tam negligenter!</i> We’d need a lot more help. If it means neither of these, then I just don’t understand it at all. Others may. There is no need to take my deci­sion as final.<br><br>I don’t, myself, want the introduction made shorter. If the publisher absolutely insists then your only two courses are<br><br>a. To go through saving a sentence and even a word here and there. I have found it is wonderful how many words one <i>can</i> save that way (what a critique this is on my own style!) but of course there is great danger of obscurity—as Horace taught us!<br>b. To jettison matter. I suppose some of the theology wd. have to be sacrificed.<br>c. Possibly the philological part could be made more purely tabular and done separate as smaller type.<br><br>But it wd. be much nicer to do none of these things.<br><br>yours<br>C.S. Lewis",
        type: "Letter",
        notes: null
    },
    {
        ...
        year: 2023,
        monthAndDay: null,
        textProvided: "Magdalene College, Cambridge<br>20 Jan 1960<br><br>Dear Shepherd<br><br>I can’t promise to be very quick, so if haste is imperative, you’ll have to go on without my verdict. But of course I’ll look at the MS. as soon as I’ve time and make any comments that occur to me, realizing that, by then, there will be the question of rejection.<br><br>All good wishes,<br>Yours<br>C.S. Lewis",
        type: "Letter",
        notes: null
    },
    {
        ...
        year: 2023,
        monthAndDay: null,
        textProvided: "The Kilns, Headington Quarry, Oxford<br>19 March 1960<br><br>Dear Shepherd<br><br>I’ve now read the Introduction, and the notes to FL. I like this edition v. much; the Introduction is one of the best we have had. My comments turn on smallish points, except for those on the editor’s treatment of “convention” and “topics.” Some of this might be reconsidered. At least I feel that Curtius’ tendency to consider literature a closed system which feeds solely on itself has been a misleading inference.<br><br>The notes tell us what they ought, but I think they wd. stand the pruning knife. Are you sure that our series is not overdoing the “parallel passage” business? The primary use of paral­lels, <i>me judice</i>, is to make clearer what is difficult in the text before us. Next comes their use as evidence that this poet was indebted to this or that predecessor. Illustrative of the general homo­geneity of a whole school, I shd. put third; the Introduction makes that clear enough. But when it comes to citing parallels for “God wot” or “worth £1000,” does it not become ridiculous? When you or I are <i>using</i> the edn., aren’t the parallels the point of the notes we find least useful, and don’t they irritate us by burying in a mass of irrelevancies the things we turn to the notes to find?<br><br>I suppose I now stand by till the notes on AL arrive?<br><br>Yours<br>C.S. Lewis",
        type: "Letter",
    ...
    },
    {
        ...
        year: 2023,
        monthAndDay: null,
        textProvided: "Dear Shepherd<br><br>Look again and I think you will find that the two bulky packets I sent you contain all the TS-FL as well as AL.<br><br>Pearsall must have his references to <i>Generides</i> if he wants, of course. I am staggered by the ascription of it and AL to a single author. A very versatile poet! I don’t myself believe that verbal parallels can even begin to prove it. The same method wd. prove that nearly all English critical work for the past 20 years was by one man. However, <i>vive le sport</i>.<br><br>Yours<br>C.S. Lewis",
        type: "Letter",
        notes: null
    },
    {
        ...
        year: 2023,
        monthAndDay: null,
        textProvided: "The Kilns, Headington Quarry, Oxford<br>13 May 62<br><br>Dear Shepherd<br><br>I don’t myself think an edn. of <i>part</i> of a Renaissance poem is the sort of thing our series was meant to do, but I won’t interfere. I am (except for week ends) now back at Cambridge “experimentally.”<br><br>Yours<br>C.S. Lewis",
        type: "Letter",
        notes: null
    },
    {
    ...
    },
    {
        ...
        year: 2009,
        monthAndDay: "April",
        textProvided: "[From The Lewis Papers, 1933; unique passages in <b>bold</b>]<br><br>Nearly they stood who fall;<br>Themselves <b>as they</b> look back<br>See always in the track<br><b>The one false step, </b>where all<br>Even <b>yet, by lightest</b> swerve<br>Of foot not yet enslaved,<br>By smallest tremour of the smallest nerve,<br>Might have been saved.<br><br>Nearly they fell who stand,<br>And with <b>cold</b> after fear<br>Look back to mark how near<br>They grazed the Siren’s land,<br><b>Wondering that subtle</b> fate,<br>By threads so spidery fine,<br>The choice of ways so small, the event so great<br>Should thus entwine.<br><br>Therefore, <b><oh man, have/b> feat<br>Lest oldest fears <b>be</b> true,<br>Lest (while no bugle blew<br><b>Thy</b> mort, while heaven seemed clear)<br>Secure, <b>thou hadst gone</b> one hair’s<br>Breadth past <b>the hair’s</b> breadth bourne,<br>Which, being once crossed forever unawares,<br><b>Denies</b> return.<br><br>[The Barfield Papers Variant 1: from a letter to Barfield, Autumn 1926?; unique passages in <b>bold</b>]<br>Nearly they stood who fall.<br>Themselves when they look back <br>See always in the track<br>One torturing spot where all,<br>Even then, by minim swerve<br>Of foot not yet enslaved,<br>By smallest <b>movement</b> of the slenderest nerve,<br>Could have been saved.<br><br>Nearly they fell who stand,<br>And, with strange after-fear,<br>Look back to mark how near <br>They grazed the Siren’s land,<br>Hence wonder grows that thou<br><b>With</b> threads so spidery fine<br><b>That everlasting to this here and now</b><br><b>Shouldst</b> thus entwine.<br><br>Therefore at times I fear<br>Lest oldest fears <b>prove</b> true;<br>Lest—while no bugle blue<br>My mort, while heaven seemed clear,<br>Secure, I have stepped one hair’s<br>Breadth past some hair-breadth bourne,<br>Which, being once crossed forever unawares,<br>Forbids return.<br><br>[The Barfield Papers Variant 2: labeled “IV” in “Half Hours with Hamilton or Quiet Moments,” a collection of 14 poems by Lewis given to Barfield in the summer of 1930; unique passages in <b>bold</b>]<br><br>Nearly they stood who fall;<br>Themselves when they look back<br>See always in the track<br>One torturing spot where all<br>Even then, by minim swerve<br>Of foot not yet enslaved,<br>By <b>faintest moving</b> of the slenderest nerve,<br>Could have been saved.<br><br>Nearly they fell who stand;<br>And with strange after fear<br>Look back to mark how near <br>They grazed the Siren’s land.<br>Hence wonder grows that fate<br>By threads so spidery fine,<br>The choice of ways so small, the event so great,<br>Therefore at times I fear<br>Lest oldest fears are true,<br>Lest, while no bugle blew<br>My mort, while heaven seemed clear,<br>Secure, I have stepped one hair’s <br>-Breadth past some hair-breadth bourne,<br>Which, being once crossed forever unawares,<br>Forbids return.<br><br>[The Barfield Papers Variant 3: the first of two poems appearing on two typed pages under the heading ‘Hell. Two Poems’ probably given to Barfield by Lewis, unknown date; unique passages in <b>bold</b>]<br>Nearly they stood who fall.<br>Themselves when they look back<br>See always on the track<br>One torturing spot where all,<br>Even then, by minim swerve<br>Of foot not yet enslaved,<br>Or <b>smallest flexion</b> of the slenderest nerve,<br>Could have been saved.<br><br>Nearly they fell who stand;<br>And, with strange after-fear,<br>Look back to the mark how near<br>They grazed the Sirens land.<br>Hence wonder grows that Fate,<br>By threads so <b>cobweb</b> fine,<br>The choice of ways so small, the event so great,<br>Should thus entwine.<br><br>Therefore, at time, I fear<br>Lest oldest fears are true,<br>Lest—while no bugle blew<br>My mort, while heaven seemed clear—<br>Secure, I have stepped one hair’s<br>Breadth past some hair-breadth bourn,<br>Which, being once crossed forever, unawares,<br>Forbids return.",
        type: "Poem",
    ...
    },
    {
        ...
        year: 1974,
        monthAndDay: null,
        textProvided: "[Scribbled throughout the notebook are various versions of the lines]<br><br>How can I ask thee Father to defend<br>In peril of war my brother’s head to-day?<br><br>[Later—perhaps for the purpose of disguising his feelings from others—he emends ‘brother’ to ‘dearest friend’, and takes the poem a bit further:]<br><br>How can I ask thee, Father, to defend<br>In peril of war my dearest friend to-day,<br>As though I knew, better than Thou, the way,<br>Or with more love than thine desired the end?<br>When I, for the length of one poor prayer, suspend<br>So hardly for his sake my thoughts, that stray<br>And wanton, thrusting twenty times a day,<br>Clean out of mind the man I call my friend;<br>Who, if he had from thee, no better care<br>Than mine, were every moment dead. But prayer<br>Thou givest to man, not man to thee: thy laws<br>Suffering our mortal wish that way to share<br>The eternal will; at taste of whose large air<br>Man’s word becomes, by miracle, a cause.",
        type: "Poem",
    ...
    },
    {
        ...
        year: 2015,
        monthAndDay: null,
        textProvided: "[I have been in a study with somebody, and that somebody pulled off the shelf a copy of one of Wyld’s books (his <i>History of Modern Colloquial English</i>? his <i>Short History of English</i>?—one or the other) and opened it up and showed it to me. {...} inside the fly-leaf of this book was a long poem in heroic couplets, entirely abusive of Wyld. The whole thing had clearly been written in one of Wyld’s lectures, commenting on the lecture as the poem was written, and it was a pretty good poem! What’s irritating is that I’ve forgotten who it was {...} The point is, I can almost remember the end of the poem. It ends up something like]<br><br>That fearful cad and bounder H.C. Wyld.",
        type: "Poem",
    ...
    },
    {
        ...
        printedIn: "<i>The Collected Poems of C.S. Lewis: A Critical Edition,</i> ed. Don W. King (Kent: Kent State University Press)",
        issueOrVolume: null,
        pageRange: "308-309, notes 63, 65, and 78",
        year: 2015,
        monthAndDay: null,
        textProvided: "[In line 194, “And grant him ground where he might grow his bread,” the word “bread” was used and the following crossed out:]<br><br>bed<br><br>[In line 206, “When dusk comes near, and the drooping, crushed,” the word “near” was used instead of]<br><br>dear<br><br>[In line 655, “As a huge, gleaming mid-harvest moon,” the alternate text for “gleaming” given by Hooper in <i>Narrative Poems</i> (125) is “huge-seeming” but in <i>Collected Poems</i> the alternate text is simply]<br><br>seeming",
        type: "Poem",
    ...
    },
    {
        ...
        printedIn: "<i>The Collected Poems of C.S. Lewis: A Critical Edition,</i> ed. Don W. King (Kent: Kent State University Press)",
        issueOrVolume: null,
        pageRange: "309-310, notes 89, 90, 93, 95, 99, 101, and 109",
        year: 2015,
        monthAndDay: null,
        textProvided: "[In line 30, “Said nothing of the knights’ return; and it became,” <i>Narrative Poems</i> (96) has “knight’s,” but the holograph gives]<br><br>knights’<br><br>[In line 55, “Strange to their wives, unwelcome to their stripling boys,” <i>Narrative Poems</i> (96) has “the” in front of “stripling,” but the holograph gives]<br><br>their<br><br>[In line 67, “Mordred, or Kai, or Caliburn, or Agravaine,” <i>Narrative Poems</i> (97) has “Calburn,” but the holograph gives:]<br><br>Caliburn<br><br>Lines 70-71, “Stirred like a babe within her. Every nerve woke wide / To torture, with low-moaning pity of self, with tears,” have two earlier revisions, of which <i>Narrative Poems</i> (97) only gives the first:]<br><br>Stirred like a babe within her and woke; and wide,<br>Prospects of woe and pits of deep dismay, with tears  <br><br>Stirred like a babe within her. Every nerve woke wide<br>To torture, with low-mourning pity of self, with tears.<br><br>[In line 130, “He sees about him noble beeches overcast,” the word “overcast” is not followed by a period in the holograph, but is in <i>Narrative Poems</i> (98).]<br><br>[Line 160, “And the spell upon the Fisher King unreversed,” is crossed out in the holograph but is present in <i>Narrative Poems</i> (99).]<br><br>[In line 243, “‘Lady, may God repay you’ says the knight, and so,” the word “knight” is not capitalized in the holograph, but is in <i>Narrative Poems</i> (102).] ",
        type: "Poem",
        notes: ["The only variations listed here are the ones that differ from, or do not appear in, <i>Narrative Poems</i>."]
    },
    {
        ...
        printedIn: "<i>The Collected Poems of C.S. Lewis: A Critical Edition,</i> ed. Don W. King (Kent: Kent State University Press)",
        issueOrVolume: null,
        pageRange: "310-312, notes 118, 122, 127, 133, 142, 143, 148, 150, 152, and 155",
        year: 2015,
        monthAndDay: null,
        textProvided: "[Canto I, lines 134-136, “(Lost, once more, the thread… / Something like ‘fans the brow’ and ‘fevered head,’ / Then ‘rough affection’)” appears in the text of the typescript but as a footnote in <i>Narrative Poems</i> (135).]<br><br>[The first word of Canto I, line 241 is printed in <i>Collected Poems</i> as “Whose” but in the typescript and in <i>Narrative Poems</i> (138, given as line 240) it is]<br><br>Who’s<br><br>[In Canto II, line 6, “Wine-coloured carpets ankle deep,” “carpets” is substituted for]<br><br>curtains<br><br>[In Canto III, line 169, “Is better than the hard assay,” Lewis wrote “assay” to replace]<br><br>essay<br><br>[Canto V, lines 67-68, “(And now on the rock slabs her feet / Touch dry, warm moss and found it sweet.)” appear in the text of the typescript but as a footnote in <i>Narrative Poems</i> (168).]<br><br>[Canto V, lines 82-89, “(Peak after peak, that had stood single / Stole from her tired eyes to mingle / And melt its fluid shape among / The notch-edged darkness whence it sprung; / And all one gloom the moorland grew / Save where some pool had caught the hue / Of the sky’s deepening arch that spread / Pale and enormous overhead.) ” appear in the text of the typescript but as a footnote in <i>Narrative Poems</i> (168).]<br><br>[Canto V, line 200, “(And milkwhite cloak of silkworm,)” appears in the text of the typescript but as a footnote in <i>Narrative Poems</i> (171).]<br><br>[Canto V, lines 248-250, “(water, rocks, and air / And sap-green lives and the warm blooded brood, / With its aloofness)” appear in the text of the typescript but as a footnote in <i>Narrative Poems</i> (173).]<br><br>[Canto V, lines 268-270, “(A long way off. The small ancestral dread / Mixed with the world’s and with her soul’s falling, / Dread within dread. She heard it calling)” appears in the text of the typescript but as a footnote in <i>Narrative Poems</i> (173).]",
        type: "Poem",
        notes: ["The only variations listed here are the ones that differ from, or do not appear in, <i>Narrative Poems</i>."]
    },
    {
        ...
        year: 2007,
        monthAndDay: null,
        textProvided: "O Caecili care, jam <br>Pridem tibi scripseram <br>Me non posse non negare <br>(Surgit aliquid amari!) <br>Tuam invitationem.<br>Diram examinationem <br>Faciendam habeo.<br>Multos pueros aro!<br><br>[Translation: “Dear Cecil, I should have written to you long ago that I just have to turn down your invitation. Something unpleasant has come up. I’ve got to deal with a deadly exam—and I’m plowing a lot of lads!”]",
        type: "Poem",
        notes: null
    },
    {
    ...
    },
    {
        ...
        year: 2024,
        monthAndDay: "April",
        textProvided: "Mód Þrýþe ne wæg _ _<br><br>Hail oh hostess, whose heart knows not<br>The temper of Þrýþ. Talk was kindly,<br>Whetted with whiskey. The white blanket,<br>Winter’s weaving, worked about us<br>Till the house was hush’d, the hearth brighter,<br>And bed-time better. In billowy nest<br>The stranger stretched—stove beside him—<br>Bless’d, blanket-warm, blithely slumbered<br>Thro’ noiseless night. Noble weaver<br>Of people’s peace, your poor servant,<br>Nat Whilk by name, on knee bended<br>Gives you grammercy for guest-friendship.",
        type: "Poem",
        notes: null
    },
    {
        ...
        year: 2024,
        monthAndDay: null,
        textProvided: "Loud-mouthed, a bully, publicly professing<br>The impartial, scientific attitude,<br>Yet, on the point of dialects, confessing<br>How pruriently class-conscious was his mood.<br>The MILES GLORIOSUS of Phonetics<br>Boasting his triumphs: evermore digressing<br>To scourge dead rivals with apologetics,<br>And pat his own broad back with transient blessing.<br>Yet did I never know his fuller power<br>Of full-fed yoked insolence, till that hour<br>Where in a mood of graciousness surprising<br>He told us ‘I am far—ahem—from despising<br>The literature of England’. Fact! It’s true:<br>He said those words in nineteen twenty-two.",
        type: "Poem",
        notes: null
    },
    {
