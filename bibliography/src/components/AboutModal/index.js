        ...
        return (
            <div>
                <a className="modal-trigger" href={"#about"}>
                    ...
                    <p className="subHeader right-align" title="Click to learn more">A Bibliography of Obscure and Newly Published Texts by <img className="signature" src={signature} alt="C.S. Lewis's singature"></img>
                    </p>
                </a>
                <div 
                    ...
                    <div className="modal-content">
                        ...
                        <p><b>PURPOSE: </b>This bibliography is an exhaustive collection of all <b>published</b> works by C.S. Lewis, however fragmentary, that are, for the most part, not obtainable in the well-known and much more easily obtainable volumes of essays, poems, stories, letters, and diaries edited by Walter Hooper.</p>
