        ...
        return (
            <div>
                <a className="modal-trigger" href={"#about"}>
                    ...
                    <p className="center-align nudge-up"><b><a href="https://jwkeena.github.io/" target="_blank" rel="noopener noreferrer" title="See my portfolio">Code and design by Justin Keena</a> · last updated 1.12.21</b></p>
                <div 
                    ...
                    <div className="modal-content">
                        ...
                        <p>i. Is not the <i>main</i> text (note that this does not apply to paratexts like prefaces, dedications, footnotes, and blurbs: blurbs are always included; prefaces, dedications, and footnotes are included if (1) there is a difference between the first edition and later editions, or (2) there is a difference between the US and UK versions, or (3) the book is out of print as of 2013) of a monograph prepared for publication by Lewis himself, apart from prior drafts and later authorial abridgement or revision: i.e., is not the main text of</p> 
